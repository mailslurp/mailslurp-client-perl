...
# 
# @param string $inbox_replier_id ID of inbox replier (optional)
# @param string $inbox_id ID of inbox (optional)
# @param string $email_id ID of email (optional)
# @param string $sent_id ID of sent (optional)
...
# @param string $sort Optional createdAt sort direction ASC or DESC (optional, default to 'ASC')
{
    ...
    __PACKAGE__->method_documentation->{ 'get_all_inbox_replier_events' } = { 
...
#
sub get_all_inbox_replier_events {
    my ($self, %args) = @_;

    # parse inputs
    my $_resource_path = '/repliers/events';
    ...
    # query params
    if ( exists $args{'inbox_replier_id'}) {
        $query_params->{'inboxReplierId'} = $self->{api_client}->to_query_value($args{'inbox_replier_id'});
    }
