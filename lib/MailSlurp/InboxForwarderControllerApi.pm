...
# @param string $inbox_id Inbox id to attach forwarder to (optional)
{
    my $params = {
...
# 
# @param string $id ID of inbox forwarder (required)
# @param InboxForwarderTestOptions $inbox_forwarder_test_options inboxForwarderTestOptions (required)
{
    my $params = {
    'id' => {
        data_type => 'string',
...
# 
# @param TestNewInboxForwarderOptions $test_new_inbox_forwarder_options testNewInboxForwarderOptions (required)
{
    my $params = {
