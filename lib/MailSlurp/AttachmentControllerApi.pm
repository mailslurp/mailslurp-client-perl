...
# 
# @param string $attachment_id ID of attachment (required)
# @param ExtractAttachmentTextOptions $extract_attachment_text_options  (optional)
{
    my $params = {
    'attachment_id' => {
        data_type => 'string',
    ...
    'extract_attachment_text_options' => {
        data_type => 'ExtractAttachmentTextOptions',
        description => '',
        required => '0',
    },
    };
    __PACKAGE__->method_documentation->{ 'extract_attachment_text' } = { 
        summary => 'Extract text from an attachment',
        params => $params,
        returns => 'ExtractAttachmentTextResult',
        };
}
# @return ExtractAttachmentTextResult
#
sub extract_attachment_text {
    my ($self, %args) = @_;

    # verify the required parameter 'attachment_id' is set
    unless (exists $args{'attachment_id'}) {
      croak("Missing the required parameter 'attachment_id' when calling extract_attachment_text");
    }

    # parse inputs
    my $_resource_path = '/attachments/{attachmentId}/text';
    ...
    my $_body_data;
    # body params
    if ( exists $args{'extract_attachment_text_options'}) {
        $_body_data = $args{'extract_attachment_text_options'};
    }
    ...
    my $_response_object = $self->{api_client}->deserialize('ExtractAttachmentTextResult', $response);
    return $_response_object;
}
...
sub get_attachment {
    ...
    my $_response_object = $self->{api_client}->deserialize('AttachmentEntityDto', $response);
    return $_response_object;
}
...
# @param string $email_id Optional emailId to filter attachments by (optional)
# @param string $sent_email_id Optional sentEmailId to filter attachments by (optional)
...
sub get_attachments {
    ...
    # query params
    if ( exists $args{'sent_email_id'}) {
        $query_params->{'sentEmailId'} = $self->{api_client}->to_query_value($args{'sent_email_id'});
    }
...
# @param int $file_size Optional byte length to save upload with (optional)
...
sub upload_attachment_bytes {
    ...
    # query params
    if ( exists $args{'content_type2'}) {
        $query_params->{'contentType'} = $self->{api_client}->to_query_value($args{'content_type2'});
    }
    ...
    # query params
    if ( exists $args{'file_size'}) {
        $query_params->{'fileSize'} = $self->{api_client}->to_query_value($args{'file_size'});
    }
    ...
    # header params
    if ( exists $args{'filename2'}) {
        $header_params->{'filename'} = $self->{api_client}->to_header_value($args{'filename2'});
    }
...
# @param string $content_type_header Optional content type header of attachment (optional)
# @param string $x_filename Optional filename header of attachment (optional)
# @param string $x_filename_raw Optional raw filename header of attachment that will be converted to punycode (optional)
# @param int $x_filesize Optional content size of attachment (optional)
# @param InlineObject1 $inline_object1  (optional)
{
    ...
    'x_filename_raw' => {
        data_type => 'string',
        description => 'Optional raw filename header of attachment that will be converted to punycode',
        required => '0',
    },
    'x_filesize' => {
        data_type => 'int',
...
sub upload_multipart_form {
    ...
    # query params
    if ( exists $args{'content_type_header'}) {
        $query_params->{'contentTypeHeader'} = $self->{api_client}->to_query_value($args{'content_type_header'});
    }
    ...
    # query params
    if ( exists $args{'x_filename_raw'}) {
        $query_params->{'x-filename-raw'} = $self->{api_client}->to_query_value($args{'x_filename_raw'});
    }

    # query params
    if ( exists $args{'x_filesize'}) {
        $query_params->{'x-filesize'} = $self->{api_client}->to_query_value($args{'x_filesize'});
    }
