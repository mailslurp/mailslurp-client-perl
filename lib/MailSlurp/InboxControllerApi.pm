...
# @param boolean $team_access DEPRECATED. Optionally filter by team access. (optional, default to false)
{
    my $params = {
    'before' => {
        data_type => 'DateTime',
...
# @param boolean $unread_only unreadOnly (optional)
{
    my $params = {
    'inbox_id' => {
        data_type => 'string',
