...
# @param boolean $favourite Is the inbox favorited. Favouriting inboxes is typically done in the dashboard for quick access or filtering (optional)
# @param string $name Optional name of the inbox. Displayed in the dashboard for easier search (optional)
