...
# @param WaitForSingleSmsOptions $wait_for_single_sms_options  (required)
{
    ...
    'wait_for_single_sms_options' => {
        data_type => 'WaitForSingleSmsOptions',
        description => '',
        required => '1',
    },
    };
    __PACKAGE__->method_documentation->{ 'wait_for_latest_sms' } = { 
        summary => 'Wait for the latest SMS message to match the provided filter conditions such as body contains keyword.',
        params => $params,
        returns => 'SmsDto',
        };
}
# @return SmsDto
#
sub wait_for_latest_sms {
    my ($self, %args) = @_;

    # verify the required parameter 'wait_for_single_sms_options' is set
    unless (exists $args{'wait_for_single_sms_options'}) {
      croak("Missing the required parameter 'wait_for_single_sms_options' when calling wait_for_latest_sms");
    }

    # parse inputs
    my $_resource_path = '/waitForLatestSms';
    ...
    my $_body_data;
    # body params
    if ( exists $args{'wait_for_single_sms_options'}) {
        $_body_data = $args{'wait_for_single_sms_options'};
    }
...
# @param WaitForSmsConditions $wait_for_sms_conditions  (required)
{
    ...
    'wait_for_sms_conditions' => {
        data_type => 'WaitForSmsConditions',
        description => '',
        required => '1',
    },
    };
    __PACKAGE__->method_documentation->{ 'wait_for_sms' } = { 
        summary => 'Wait for an SMS message to match the provided filter conditions such as body contains keyword.',
        params => $params,
        returns => 'ARRAY[SmsPreview]',
        };
}
...
sub wait_for_sms {
    ...
    unless (exists $args{'wait_for_sms_conditions'}) {
      croak("Missing the required parameter 'wait_for_sms_conditions' when calling wait_for_sms");
    }

    # parse inputs
    my $_resource_path = '/waitForSms';
    ...
    my $_body_data;
    # body params
    if ( exists $args{'wait_for_sms_conditions'}) {
        $_body_data = $args{'wait_for_sms_conditions'};
    }
    ...
    my $_response_object = $self->{api_client}->deserialize('ARRAY[SmsPreview]', $response);
    return $_response_object;
}
