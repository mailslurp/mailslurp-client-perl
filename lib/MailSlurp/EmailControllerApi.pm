...
# @param SendEmailOptions $send_email_options  (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'can_send' } = { 
        summary => 'Check whether an email send would be accepted',
        params => $params,
...
# @param string $email_id  (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'check_email_audit1' } = { 
        summary => 'Run aggregate email audit for a stored email',
        params => $params,
...
#
sub check_email_audit1 {
    my ($self, %args) = @_;

    # verify the required parameter 'email_id' is set
    unless (exists $args{'email_id'}) {
      croak("Missing the required parameter 'email_id' when calling check_email_audit1");
    }

    # parse inputs
    my $_resource_path = '/emails/{emailId}/check-email-audit';
...
# @param string $email_id  (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'check_email_body' } = { 
        summary => 'Check email body for broken links, images, and spelling issues',
        params => $params,
        returns => 'CheckEmailBodyResults',
        };
}
# @return CheckEmailBodyResults
#
sub check_email_body {
    my ($self, %args) = @_;

    # verify the required parameter 'email_id' is set
    unless (exists $args{'email_id'}) {
      croak("Missing the required parameter 'email_id' when calling check_email_body");
    }

    # parse inputs
    my $_resource_path = '/emails/{emailId}/check-email-body';
    ...
    my $_response_object = $self->{api_client}->deserialize('CheckEmailBodyResults', $response);
    return $_response_object;
}
...
# @param string $email_id  (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'check_email_body_feature_support' } = { 
        summary => 'Check client support for features used in a stored email body',
        params => $params,
...
# @param CheckEmailClientSupportOptions $check_email_client_support_options  (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'check_email_client_support' } = { 
        summary => 'Check email-client support for a provided HTML body',
        params => $params,
...
# @param string $email_id  (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'create_email_audit_for_email' } = { 
        summary => 'Persist aggregate email audit for a stored email',
        params => $params,
...
#
sub create_email_audit_for_email {
    my ($self, %args) = @_;

    # verify the required parameter 'email_id' is set
    unless (exists $args{'email_id'}) {
      croak("Missing the required parameter 'email_id' when calling create_email_audit_for_email");
    }

    # parse inputs
    my $_resource_path = '/emails/{emailId}/audit';
...
# @param string $email_id  (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'get_email' } = { 
        summary => 'Get hydrated email (headers and body)',
        params => $params,
        returns => 'Email',
        };
}
...
sub get_email {
    ...
    # 'Accept' and 'Content-Type' header
    my $_header_accept = $self->{api_client}->select_header_accept('application/json;charset=UTF-8', 'application/xml;charset=UTF-8', 'application/json; charset=UTF-8', 'application/xml; charset=UTF-8');
    if ($_header_accept) {
        $header_params->{'Accept'} = $_header_accept;
    }
    $header_params->{'Content-Type'} = $self->{api_client}->select_header_content_type();
...
# @param string $email_id ID of email (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'get_email_attachments' } = { 
        summary => 'List attachment metadata for an email',
        params => $params,
...
# 
# @param string $email_id ID of email to extract codes from (required)
# @param ExtractCodesOptions $extract_codes_options  (optional)
{
    my $params = {
    'email_id' => {
        data_type => 'string',
        description => 'ID of email to extract codes from',
        required => '1',
    },
    'extract_codes_options' => {
        data_type => 'ExtractCodesOptions',
        description => '',
        required => '0',
    },
    };
    __PACKAGE__->method_documentation->{ 'get_email_codes' } = { 
        summary => 'Extract verification codes from an email',
        params => $params,
        returns => 'ExtractCodesResult',
        };
}
...
sub get_email_codes {
    ...
    # verify the required parameter 'email_id' is set
    unless (exists $args{'email_id'}) {
      croak("Missing the required parameter 'email_id' when calling get_email_codes");
    }

    # parse inputs
    my $_resource_path = '/emails/{emailId}/codes';
    ...
    my $_body_data;
    # body params
    if ( exists $args{'extract_codes_options'}) {
        $_body_data = $args{'extract_codes_options'};
    }
    ...
    my $_response_object = $self->{api_client}->deserialize('ExtractCodesResult', $response);
    return $_response_object;
}
...
# @param ContentMatchOptions $content_match_options  (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'get_email_content_match' } = { 
        summary => 'Run regex against hydrated email body and return matches',
        params => $params,
...
# @param boolean $strict Strict content type match (optional)
# @param int $index Index of content type part if multiple (optional)
{
    my $params = {
    'email_id' => {
        data_type => 'string',
...
# @param string $content_type Content type (required)
# @param boolean $strict Strict content type match (optional)
# @param int $index Index of content type part if multiple. Starts from 0 and applies to the result list after selecting for your content type. Content type parts are sorted by order found in original MIME message. (optional)
{
    my $params = {
    'email_id' => {
        data_type => 'string',
    ...
    'index' => {
        data_type => 'int',
        description => 'Index of content type part if multiple. Starts from 0 and applies to the result list after selecting for your content type. Content type parts are sorted by order found in original MIME message.',
        required => '0',
    },
    };
    __PACKAGE__->method_documentation->{ 'get_email_content_part_content' } = { 
        summary => 'Get multipart content part as raw response',
        params => $params,
        returns => 'string',
        };
}
# @return string
#
sub get_email_content_part_content {
    my ($self, %args) = @_;

    # verify the required parameter 'email_id' is set
    unless (exists $args{'email_id'}) {
      croak("Missing the required parameter 'email_id' when calling get_email_content_part_content");
    }

    # verify the required parameter 'content_type' is set
    unless (exists $args{'content_type'}) {
      croak("Missing the required parameter 'content_type' when calling get_email_content_part_content");
    }

    # parse inputs
    my $_resource_path = '/emails/{emailId}/contentPart/raw';
...
# @param boolean $replace_cid_images  (optional, default to false)
{
    ...
    __PACKAGE__->method_documentation->{ 'get_email_html' } = { 
        summary => 'Get hydrated email HTML for browser rendering',
        params => $params,
        returns => 'string',
        };
}
...
# @param boolean $replace_cid_images  (optional, default to false)
{
    ...
    __PACKAGE__->method_documentation->{ 'get_email_html_json' } = { 
        summary => 'Get hydrated email HTML wrapped in JSON',
        params => $params,
...
# @param string $html_selector HTML selector to search for. Uses JQuery/JSoup/CSS style selector like &#39;.my-div&#39; to match content. See https://jsoup.org/apidocs/org/jsoup/select/Selector.html for more information. (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'get_email_html_query' } = { 
        summary => 'Query hydrated HTML body and return matching text lines',
        params => $params,
...
# @param string $selector Optional HTML query selector for links (optional)
{
    my $params = {
    'email_id' => {
        data_type => 'string',
    ...
    __PACKAGE__->method_documentation->{ 'get_email_links' } = { 
        summary => 'Extract links from an email HTML body',
        params => $params,
...
sub get_email_links {
    ...
    if ( exists $args{'selector'}) {
        $query_params->{'selector'} = $self->{api_client}->to_query_value($args{'selector'});
    }
...
# @param GetEmailScreenshotOptions $get_email_screenshot_options  (required)
{
    ...
    'get_email_screenshot_options' => {
        data_type => 'GetEmailScreenshotOptions',
        description => '',
        required => '1',
    },
    };
    __PACKAGE__->method_documentation->{ 'get_email_screenshot_as_base64' } = { 
        summary => 'Take a screenshot of an email in a browser and return base64 encoded string',
        params => $params,
        returns => 'EmailScreenshotResult',
        };
}
# @return EmailScreenshotResult
#
sub get_email_screenshot_as_base64 {
    my ($self, %args) = @_;

    # verify the required parameter 'email_id' is set
    unless (exists $args{'email_id'}) {
      croak("Missing the required parameter 'email_id' when calling get_email_screenshot_as_base64");
    }

    # verify the required parameter 'get_email_screenshot_options' is set
    unless (exists $args{'get_email_screenshot_options'}) {
      croak("Missing the required parameter 'get_email_screenshot_options' when calling get_email_screenshot_as_base64");
    }

    # parse inputs
    my $_resource_path = '/emails/{emailId}/screenshot/base64';
    ...
    my $_body_data;
    # body params
    if ( exists $args{'get_email_screenshot_options'}) {
        $_body_data = $args{'get_email_screenshot_options'};
    }
    ...
    my $_response_object = $self->{api_client}->deserialize('EmailScreenshotResult', $response);
    return $_response_object;
}
...
# @param GetEmailScreenshotOptions $get_email_screenshot_options  (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'get_email_screenshot_as_binary' } = { 
...
# @return void
#
sub get_email_screenshot_as_binary {
    my ($self, %args) = @_;

    # verify the required parameter 'email_id' is set
    unless (exists $args{'email_id'}) {
      croak("Missing the required parameter 'email_id' when calling get_email_screenshot_as_binary");
    }

    # verify the required parameter 'get_email_screenshot_options' is set
    unless (exists $args{'get_email_screenshot_options'}) {
      croak("Missing the required parameter 'get_email_screenshot_options' when calling get_email_screenshot_as_binary");
    }

    # parse inputs
    my $_resource_path = '/emails/{emailId}/screenshot/binary';
...
# 
# @param string $email_id ID of email to extract signature from (required)
{
    my $params = {
    'email_id' => {
        data_type => 'string',
        description => 'ID of email to extract signature from',
        required => '1',
    },
    };
    __PACKAGE__->method_documentation->{ 'get_email_signature' } = { 
        summary => 'Extract signature from an inbound email',
        params => $params,
        returns => 'EmailSignatureParseResult',
        };
}
...
sub get_email_signature {
    ...
    # verify the required parameter 'email_id' is set
    unless (exists $args{'email_id'}) {
      croak("Missing the required parameter 'email_id' when calling get_email_signature");
    }

    # parse inputs
    my $_resource_path = '/emails/{emailId}/signature';
    ...
    my $_response_object = $self->{api_client}->deserialize('EmailSignatureParseResult', $response);
    return $_response_object;
}
...
# 
# @param string $email_id  (required)
# @param boolean $decode Deprecated and ignored. Retained for backwards compatibility. (optional)
{
    my $params = {
    'email_id' => {
        data_type => 'string',
    ...
    'decode' => {
        data_type => 'boolean',
        description => 'Deprecated and ignored. Retained for backwards compatibility.',
        required => '0',
    },
    };
    __PACKAGE__->method_documentation->{ 'get_email_summary' } = { 
        summary => 'Get email summary (headers/metadata only)',
        params => $params,
        returns => 'EmailPreview',
        };
}
# @return EmailPreview
#
sub get_email_summary {
    my ($self, %args) = @_;

    # verify the required parameter 'email_id' is set
    unless (exists $args{'email_id'}) {
      croak("Missing the required parameter 'email_id' when calling get_email_summary");
    }

    # parse inputs
    my $_resource_path = '/emails/{emailId}/summary';
...
# @param string $line_separator Line separator character (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'get_email_text_lines' } = { 
        summary => 'Extract normalized text lines from email body',
        params => $params,
        returns => 'EmailTextLinesResult',
        };
}
...
# @param string $thread_id  (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'get_email_thread' } = { 
        summary => 'Get email thread metadata by thread ID',
        params => $params,
        returns => 'EmailThreadDto',
        };
}
# @return EmailThreadDto
#
sub get_email_thread {
    my ($self, %args) = @_;

    # verify the required parameter 'thread_id' is set
    unless (exists $args{'thread_id'}) {
      croak("Missing the required parameter 'thread_id' when calling get_email_thread");
    }

    # parse inputs
    my $_resource_path = '/emails/threads/{threadId}';
    ...
    my $_response_object = $self->{api_client}->deserialize('EmailThreadDto', $response);
    return $_response_object;
}
...
# @param string $sort Optional createdAt sort direction ASC or DESC (optional, default to 'ASC')
{
    ...
    __PACKAGE__->method_documentation->{ 'get_email_thread_items' } = { 
        summary => 'Get messages in a specific email thread',
        params => $params,
        returns => 'EmailThreadItemsDto',
        };
}
# @return EmailThreadItemsDto
#
sub get_email_thread_items {
    my ($self, %args) = @_;

    # verify the required parameter 'thread_id' is set
    unless (exists $args{'thread_id'}) {
      croak("Missing the required parameter 'thread_id' when calling get_email_thread_items");
    }

    # parse inputs
    my $_resource_path = '/emails/threads/{threadId}/items';
    ...
    my $_response_object = $self->{api_client}->deserialize('EmailThreadItemsDto', $response);
    return $_response_object;
}
...
# 
# @param string $html_selector Optional inbox filter. Query parameter name is &#x60;htmlSelector&#x60; for legacy compatibility. (optional)
# @param int $page Optional page index in email thread pagination (optional, default to 0)
# @param int $size Optional page size in email thread pagination. Maximum size is 100. Use page index and sort to page through larger results (optional, default to 20)
# @param string $sort Optional createdAt sort direction ASC or DESC (optional, default to 'ASC')
# @param string $search_filter Optional search filter search filter for email threads. (optional)
# @param DateTime $since Optional filter email threads created since time (optional)
# @param DateTime $before Optional filter emails threads created before given date time (optional)
{
    my $params = {
    'html_selector' => {
        data_type => 'string',
        description => 'Optional inbox filter. Query parameter name is &#x60;htmlSelector&#x60; for legacy compatibility.',
        required => '0',
    },
    'page' => {
        data_type => 'int',
    ...
    'size' => {
        data_type => 'int',
        description => 'Optional page size in email thread pagination. Maximum size is 100. Use page index and sort to page through larger results',
        required => '0',
    },
    'sort' => {
        data_type => 'string',
    ...
    __PACKAGE__->method_documentation->{ 'get_email_threads' } = { 
        summary => 'List email threads in paginated form',
        params => $params,
        returns => 'PageEmailThreadProjection',
        };
}
# @return PageEmailThreadProjection
#
sub get_email_threads {
    my ($self, %args) = @_;

    # parse inputs
    my $_resource_path = '/emails/threads';
    ...
    my $_response_object = $self->{api_client}->deserialize('PageEmailThreadProjection', $response);
    return $_response_object;
}
...
# @param boolean $favourited Optional filter emails that are favourited (optional)
# @param boolean $sync_connectors Sync connectors (optional)
# @param string $plus_address_id Optional plus address ID filter (optional)
...
sub get_emails_offset_paginated {
    ...
    if ( exists $args{'plus_address_id'}) {
        $query_params->{'plusAddressId'} = $self->{api_client}->to_query_value($args{'plus_address_id'});
    }
...
# @param string $size  (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'get_gravatar_url_for_email_address' } = { 
        summary => 'Get Gravatar URL for an email address',
        params => $params,
        returns => 'GravatarUrl',
        };
}
...
# @param DateTime $before Optional filter emails received before given date time (optional)
# @param boolean $sync_connectors Sync connectors (optional)
# @param boolean $favourited Search only favorited emails (optional)
# @param string $plus_address_id Optional plus address ID filter (optional)
{
    my $params = {
    'inbox_id' => {
    ...
    __PACKAGE__->method_documentation->{ 'get_organization_emails_paginated' } = { 
        summary => 'List organization-visible emails',
        params => $params,
        returns => 'PageEmailProjection',
        };
}
...
# 
# @param string $inbox_id Inbox ID filter for unread count scope (optional)
{
    my $params = {
    'inbox_id' => {
        data_type => 'string',
        description => 'Inbox ID filter for unread count scope',
        required => '0',
    },
    };
...
# @param boolean $sync_connectors Sync connectors (optional)
# @param boolean $favourited Search only favourited emails (optional)
# @param string $plus_address_id Optional plus address ID filter (optional)
{
    my $params = {
...
# 
# @param string $email_id ID of email to set favourite state (required)
# @param boolean $favourited  (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'set_email_favourited' } = { 
...
# @return void
#
sub set_email_favourited {
    my ($self, %args) = @_;

    # verify the required parameter 'email_id' is set
    unless (exists $args{'email_id'}) {
      croak("Missing the required parameter 'email_id' when calling set_email_favourited");
    }

    # verify the required parameter 'favourited' is set
    unless (exists $args{'favourited'}) {
      croak("Missing the required parameter 'favourited' when calling set_email_favourited");
    }

    # parse inputs
    my $_resource_path = '/emails/{emailId}/favourite';
