...
sub get_attachments {
    ...
    # verify the required parameter 'email_id' is set
    unless (exists $args{'email_id'}) {
      croak("Missing the required parameter 'email_id' when calling get_attachments");
    }
...
sub send_email_source_optional {
    ...
    # verify the required parameter 'inbox_id' is set
    unless (exists $args{'inbox_id'}) {
      croak("Missing the required parameter 'inbox_id' when calling send_email_source_optional");
    }
