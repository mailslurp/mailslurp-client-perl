...
sub submit_form {
    ...
    if ( exists $args{'_email_address'} ) {
                $form_params->{'_emailAddress'} = $self->{api_client}->to_form_value($args{'_email_address'});
    }
    
    # form params
    if ( exists $args{'_redirect_to'} ) {
                $form_params->{'_redirectTo'} = $self->{api_client}->to_form_value($args{'_redirect_to'});
    }
    
    # form params
    if ( exists $args{'_spam_check'} ) {
                $form_params->{'_spamCheck'} = $self->{api_client}->to_form_value($args{'_spam_check'});
    }
    
    # form params
    if ( exists $args{'_subject'} ) {
                $form_params->{'_subject'} = $self->{api_client}->to_form_value($args{'_subject'});
    }
    
    # form params
    if ( exists $args{'_success_message'} ) {
                $form_params->{'_successMessage'} = $self->{api_client}->to_form_value($args{'_success_message'});
    }
    
    # form params
    if ( exists $args{'_to'} ) {
                $form_params->{'_to'} = $self->{api_client}->to_form_value($args{'_to'});
    }
    
    # form params
    if ( exists $args{'other_parameters'} ) {
                $form_params->{'otherParameters'} = $self->{api_client}->to_form_value($args{'other_parameters'});
    }
