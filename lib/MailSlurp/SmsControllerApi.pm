...
# 
# @param string $sms_id ID of SMS to extract codes from (required)
# @param ExtractCodesOptions $extract_codes_options  (optional)
{
    my $params = {
    'sms_id' => {
        data_type => 'string',
        description => 'ID of SMS to extract codes from',
        required => '1',
    },
    ...
    __PACKAGE__->method_documentation->{ 'get_sms_codes' } = { 
        summary => 'Extract verification codes from an SMS',
        params => $params,
...
sub get_sms_codes {
    ...
    # verify the required parameter 'sms_id' is set
    unless (exists $args{'sms_id'}) {
      croak("Missing the required parameter 'sms_id' when calling get_sms_codes");
    }

    # parse inputs
    my $_resource_path = '/sms/{smsId}/codes';
...
# 
# @param boolean $read  (optional, default to true)
# @param string $phone_number_id  (optional)
{
    my $params = {
    'read' => {
    ...
    __PACKAGE__->method_documentation->{ 'mark_all_sms_as_read' } = { 
        summary => 'Mark all SMS messages as read or unread',
        params => $params,
        returns => undef,
        };
}
# @return void
#
sub mark_all_sms_as_read {
    my ($self, %args) = @_;

    # parse inputs
    my $_resource_path = '/sms/read';
...
# @param boolean $read  (optional, default to true)
{
    ...
    __PACKAGE__->method_documentation->{ 'mark_sms_as_read' } = { 
        summary => 'Mark an SMS as read or unread',
        params => $params,
        returns => 'SmsDto',
        };
}
# @return SmsDto
#
sub mark_sms_as_read {
    my ($self, %args) = @_;

    # verify the required parameter 'sms_id' is set
    unless (exists $args{'sms_id'}) {
      croak("Missing the required parameter 'sms_id' when calling mark_sms_as_read");
    }

    # parse inputs
    my $_resource_path = '/sms/{smsId}/read';
