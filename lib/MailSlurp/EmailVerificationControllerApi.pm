...
# 
{
    ...
    __PACKAGE__->method_documentation->{ 'delete_all_validation_requests' } = { 
...
# @return void
#
sub delete_all_validation_requests {
    my ($self, %args) = @_;

    # parse inputs
    my $_resource_path = '/email-verification';
...
# @param string $id  (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'delete_validation_request' } = { 
...
# @return void
#
sub delete_validation_request {
    my ($self, %args) = @_;

    # verify the required parameter 'id' is set
    unless (exists $args{'id'}) {
      croak("Missing the required parameter 'id' when calling delete_validation_request");
    }

    # parse inputs
    my $_resource_path = '/email-verification/{id}';
...
# 
# @param EmailIntelligenceOptions $email_intelligence_options  (required)
{
    my $params = {
    'email_intelligence_options' => {
        data_type => 'EmailIntelligenceOptions',
        description => '',
        required => '1',
    },
    };
    __PACKAGE__->method_documentation->{ 'get_email_intelligence' } = { 
        summary => 'Get intelligence score and breakdown for email/domain targets. Per unit billing for non-cached evaluations.',
        params => $params,
        returns => 'EmailIntelligenceListResult',
        };
}
# @return EmailIntelligenceListResult
#
sub get_email_intelligence {
    my ($self, %args) = @_;

    # verify the required parameter 'email_intelligence_options' is set
    unless (exists $args{'email_intelligence_options'}) {
      croak("Missing the required parameter 'email_intelligence_options' when calling get_email_intelligence");
    }

    # parse inputs
    my $_resource_path = '/email-verification/intelligence';
    ...
    my $_body_data;
    # body params
    if ( exists $args{'email_intelligence_options'}) {
        $_body_data = $args{'email_intelligence_options'};
    }
    ...
    my $_response_object = $self->{api_client}->deserialize('EmailIntelligenceListResult', $response);
