...
# @param TestInboxRulesetReceivingOptions $test_inbox_ruleset_receiving_options  (required)
{
    ...
    'test_inbox_ruleset_receiving_options' => {
        data_type => 'TestInboxRulesetReceivingOptions',
        description => '',
        required => '1',
    },
    };
    __PACKAGE__->method_documentation->{ 'test_inbox_ruleset_receiving' } = { 
        summary => 'Test receiving with inbox rulesets',
        params => $params,
        returns => 'TestInboxRulesetReceivingResult',
        };
}
# @return TestInboxRulesetReceivingResult
#
sub test_inbox_ruleset_receiving {
    my ($self, %args) = @_;

    # verify the required parameter 'test_inbox_ruleset_receiving_options' is set
    unless (exists $args{'test_inbox_ruleset_receiving_options'}) {
      croak("Missing the required parameter 'test_inbox_ruleset_receiving_options' when calling test_inbox_ruleset_receiving");
    }
    ...
    my $_body_data;
    # body params
    if ( exists $args{'test_inbox_ruleset_receiving_options'}) {
        $_body_data = $args{'test_inbox_ruleset_receiving_options'};
    }
    ...
    my $_response_object = $self->{api_client}->deserialize('TestInboxRulesetReceivingResult', $response);
    return $_response_object;
}
...
# @param TestInboxRulesetSendingOptions $test_inbox_ruleset_sending_options  (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'test_inbox_ruleset_sending' } = { 
        summary => 'Test sending with inbox rulesets',
        params => $params,
        returns => 'TestInboxRulesetSendingResult',
        };
}
# @return TestInboxRulesetSendingResult
#
sub test_inbox_ruleset_sending {
    my ($self, %args) = @_;
    ...
    unless (exists $args{'test_inbox_ruleset_sending_options'}) {
      croak("Missing the required parameter 'test_inbox_ruleset_sending_options' when calling test_inbox_ruleset_sending");
    }
    ...
    my $_response_object = $self->{api_client}->deserialize('TestInboxRulesetSendingResult', $response);
    return $_response_object;
}
