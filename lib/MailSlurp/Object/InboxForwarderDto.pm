...
#
package MailSlurp::Object::InboxForwarderDto;
...
__PACKAGE__->class_documentation({description => 'Inbox forwarder. Describes how an inbox will forward matching emails to designated recipients.',
...
__PACKAGE__->method_documentation({
    ...
    'match' => {
        datatype => 'string',
        base_name => 'match',
        description => 'Pattern to apply to field',
        format => '',
        read_only => '',
            },
