...
#
package MailSlurp::Object::PhoneSmsPrepaidCreditsDto;
...
use MailSlurp::Object::PhoneSmsPrepaidCreditDto;
...
__PACKAGE__->method_documentation({
    ...
    'total_remaining_credits' => {
        datatype => 'int',
        base_name => 'totalRemainingCredits',
        description => '',
        format => '',
        read_only => '',
            },
    'items' => {
        datatype => 'ARRAY[PhoneSmsPrepaidCreditDto]',
        base_name => 'items',
        description => '',
        format => '',
        read_only => '',
