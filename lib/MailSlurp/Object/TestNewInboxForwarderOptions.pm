...
#
package MailSlurp::Object::TestNewInboxForwarderOptions;
...
__PACKAGE__->class_documentation({description => 'Options for testing new inbox forwarder rules',
...
__PACKAGE__->method_documentation({
    'inbox_forwarder_test_options' => {
        datatype => 'InboxForwarderTestOptions',
        base_name => 'inboxForwarderTestOptions',
        description => '',
        format => '',
        read_only => '',
            },
    'create_inbox_forwarder_options' => {
        datatype => 'CreateInboxForwarderOptions',
        base_name => 'createInboxForwarderOptions',
        description => '',
        format => '',
        read_only => '',
            },
