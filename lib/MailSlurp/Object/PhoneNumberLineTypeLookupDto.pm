...
#
package MailSlurp::Object::PhoneNumberLineTypeLookupDto;
...
use MailSlurp::Object::PhoneNumberLineTypeIntelligenceDto;
...
__PACKAGE__->method_documentation({
    ...
    'validation_errors' => {
        ...
        base_name => 'validationErrors',
        description => '',
        format => '',
        read_only => '',
            },
    'line_type_intelligence' => {
        datatype => 'PhoneNumberLineTypeIntelligenceDto',
        base_name => 'lineTypeIntelligence',
        description => '',
        format => '',
        read_only => '',
            },
    'mailslurp_phone_number' => {
        datatype => 'boolean',
        base_name => 'mailslurpPhoneNumber',
        description => '',
        format => '',
        read_only => '',
            },
