...
#
package MailSlurp::Object::ConnectorSyncRequestResultException;
...
__PACKAGE__->method_documentation({
    'cause' => {
        datatype => 'ConnectorSyncRequestResultExceptionCause',
        base_name => 'cause',
        description => '',
        format => '',
        read_only => '',
    ...
    'stack_trace' => {
        datatype => 'ARRAY[ConnectorSyncRequestResultExceptionCauseStackTrace]',
    ...
    'suppressed' => {
        datatype => 'ARRAY[ConnectorSyncRequestResultExceptionCauseSuppressed]',
        base_name => 'suppressed',
        description => '',
        format => '',
        read_only => '',
            },
