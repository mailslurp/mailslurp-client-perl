...
#
package MailSlurp::Object::DmarcReportMetadata;
...
__PACKAGE__->class_documentation({description => 'DMARC aggregate report metadata and policy information',
