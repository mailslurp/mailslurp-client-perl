...
#
package MailSlurp::Object::CreateContactOptions;
...
__PACKAGE__->class_documentation({description => 'Options for creating an email contact in address book',
...
__PACKAGE__->method_documentation({
    ...
    'opt_out' => {
        datatype => 'boolean',
        base_name => 'optOut',
        description => 'Has the user explicitly or implicitly opted out of being contacted? If so MailSlurp will ignore them in all actions.',
        format => '',
        read_only => '',
            },
    'group_id' => {
    ...
    'verify_email_addresses' => {
        datatype => 'boolean',
        base_name => 'verifyEmailAddresses',
