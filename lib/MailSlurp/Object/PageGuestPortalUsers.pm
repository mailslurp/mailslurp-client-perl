...
#
package MailSlurp::Object::PageGuestPortalUsers;
...
__PACKAGE__->class_documentation({description => 'Paginated guest portal users',
...
__PACKAGE__->method_documentation({
    'content' => {
        datatype => 'ARRAY[GuestPortalUserProjection]',
        base_name => 'content',
        description => '',
        format => '',
        read_only => '',
