...
#
package MailSlurp::Object::AbstractWebhookPayload;
...
__PACKAGE__->class_documentation({description => 'Abstract webhook payload. Use the correct payload type for your webhook event type in order to access all the specific properties for that event. See the &#x60;NEW_EMAIL&#x60;,&#x60;NEW_CONTACT&#x60; and &#x60;NEW_ATTACHMENT&#x60; payloads for the properties available for those events.',
