...
#
package MailSlurp::Object::PageUnknownMissedEmailProjection;
...
__PACKAGE__->class_documentation({description => 'Paginated unknown MissedEmail results. Unknown missed emails are emails that were sent to MailSlurp /Page index starts at zero. Projection results may omit larger entity fields. For fetching a full entity use the projection ID with individual method calls.',
...
__PACKAGE__->method_documentation({
    'content' => {
        datatype => 'ARRAY[UnknownMissedEmailProjection]',
        base_name => 'content',
        description => '',
        format => '',
        read_only => '',
