...
#
package MailSlurp::Object::TestNewInboxRulesetOptions;
...
__PACKAGE__->class_documentation({description => 'Test inbox ruleset options',
...
__PACKAGE__->method_documentation({
    'inbox_ruleset_test_options' => {
        datatype => 'InboxRulesetTestOptions',
        base_name => 'inboxRulesetTestOptions',
        description => '',
        format => '',
        read_only => '',
            },
    'create_inbox_ruleset_options' => {
        datatype => 'CreateInboxRulesetOptions',
        base_name => 'createInboxRulesetOptions',
        description => '',
        format => '',
        read_only => '',
            },
