...
#
package MailSlurp::Object::GenerateStructuredContentAttachmentOptions;
...
__PACKAGE__->class_documentation({description => 'Options for generating structured content output from an attachment',
