...
#
package MailSlurp::Object::LookupMtaStsDomainResults;
...
__PACKAGE__->method_documentation({
    ...
    'records' => {
        datatype => 'ARRAY[DNSLookupResult]',
        base_name => 'records',
        description => '',
        format => '',
        read_only => '',
