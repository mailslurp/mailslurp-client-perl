...
#
package MailSlurp::Object::PageComplaint;
...
__PACKAGE__->class_documentation({description => 'Paginated complaint email. Page index starts at zero. Projection results may omit larger entity fields. For fetching a full entity use the projection ID with individual method calls.',
                                  class => 'PageComplaint',
                                  required => [], # TODO
}                                 );
