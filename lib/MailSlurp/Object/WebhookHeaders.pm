...
#
package MailSlurp::Object::WebhookHeaders;
...
__PACKAGE__->class_documentation({description => 'Webhook HTTP headers to include with each request from MailSlurp to your server',
...
__PACKAGE__->method_documentation({
    'headers' => {
        datatype => 'ARRAY[WebhookHeaderNameValue]',
        base_name => 'headers',
