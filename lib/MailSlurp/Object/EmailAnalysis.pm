...
#
package MailSlurp::Object::EmailAnalysis;
...
__PACKAGE__->class_documentation({description => 'Analysis result for email. Each verdict property is a string PASS|FAIL|GRAY or dynamic error message',
                                  class => 'EmailAnalysis',
                                  required => [], # TODO
}                                 );
...
__PACKAGE__->method_documentation({
    ...
    'dmarc_verdict' => {
        datatype => 'string',
        base_name => 'dmarcVerdict',
        description => 'Verdict of Domain-based Message Authentication Reporting and Conformance analysis',
        format => '',
        read_only => '',
            },
});
