...
#
package MailSlurp::Object::PageExpiredInboxRecordProjection;
...
__PACKAGE__->class_documentation({description => 'Paginated expired inbox results. Page index starts at zero. Projection results may omit larger entity fields. For fetching a full inbox entity use the projection ID with individual method calls.',
...
__PACKAGE__->method_documentation({
    'content' => {
        datatype => 'ARRAY[ExpiredInboxRecordProjection]',
        base_name => 'content',
        description => '',
        format => '',
        read_only => '',
