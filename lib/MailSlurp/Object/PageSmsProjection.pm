...
#
package MailSlurp::Object::PageSmsProjection;
...
__PACKAGE__->class_documentation({description => 'Paginated SMS messages. Page index starts at zero. Projection results may omit larger entity fields. For fetching a full entity use the projection ID with individual method calls.',
