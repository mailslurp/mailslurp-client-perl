...
#
package MailSlurp::Object::AccountBounceBlockDto;
...
__PACKAGE__->method_documentation({
    ...
    'bounce_count_today' => {
        datatype => 'int',
        base_name => 'bounceCountToday',
        description => '',
        format => '',
        read_only => '',
            },
    'maximum_daily_bounces' => {
        datatype => 'int',
        base_name => 'maximumDailyBounces',
        description => '',
        format => '',
        read_only => '',
            },
    'maximum_account_bounces' => {
        datatype => 'int',
        base_name => 'maximumAccountBounces',
        description => '',
        format => '',
        read_only => '',
            },
