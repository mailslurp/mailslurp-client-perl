...
__PACKAGE__->class_documentation({description => 'Representation of a webhook for an inbox. The URL specified will be using by MailSlurp whenever an email is received by the attached inbox.',
                                  class => 'WebhookDto',
                                  required => [], # TODO
}                                 );
