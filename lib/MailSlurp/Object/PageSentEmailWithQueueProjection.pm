...
#
package MailSlurp::Object::PageSentEmailWithQueueProjection;
...
__PACKAGE__->class_documentation({description => 'Paginated sent email results for emails sent with queue. Page index starts at zero. Projection results may omit larger entity fields. For fetching a full sent email entity use the projection ID with individual method calls.',
...
__PACKAGE__->method_documentation({
    'content' => {
        datatype => 'ARRAY[SendWithQueueResult]',
        base_name => 'content',
        description => '',
        format => '',
        read_only => '',
