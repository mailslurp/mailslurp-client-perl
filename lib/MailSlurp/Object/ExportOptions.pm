...
#
package MailSlurp::Object::ExportOptions;
...
__PACKAGE__->class_documentation({description => 'Options for exporting user data',
                                  class => 'ExportOptions',
                                  required => [], # TODO
}                                 );
...
__PACKAGE__->method_documentation({
    ...
    'exclude_previously_exported' => {
        datatype => 'boolean',
        base_name => 'excludePreviouslyExported',
        description => '',
        format => '',
        read_only => '',
            },
