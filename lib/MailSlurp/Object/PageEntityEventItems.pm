...
#
package MailSlurp::Object::PageEntityEventItems;
...
__PACKAGE__->class_documentation({description => 'Paginated event items like webhook events and forwarding. Page index starts at zero. Projection results may omit larger entity fields. For fetching a full entity use the projection ID with individual method calls.',
...
__PACKAGE__->method_documentation({
    'content' => {
        datatype => 'ARRAY[EntityEventItemProjection]',
        base_name => 'content',
        description => '',
        format => '',
        read_only => '',
