...
__PACKAGE__->class_documentation({description => 'Options for creating inbox rulesets. Inbox rulesets can be used to block, allow, or forward emails when sending or receiving using the inbox.',
...
__PACKAGE__->method_documentation({
    'action' => {
        datatype => 'string',
        base_name => 'action',
        description => 'Action to be taken when the ruleset matches an email for the given scope. For example: &#x60;BLOCK&#x60; action with target &#x60;*&#x60; and scope &#x60;SENDING_EMAILS&#x60; blocks sending to all recipients. Note &#x60;ALLOW&#x60; takes precedent over &#x60;BLOCK&#x60;.',
        format => '',
        read_only => '',
            },
    'scope' => {
