...
#
package MailSlurp::Object::CreateConnectorOptions;
...
__PACKAGE__->method_documentation({
    ...
    'connector_auth_type' => {
        datatype => 'string',
        base_name => 'connectorAuthType',
        description => '',
        format => '',
        read_only => '',
            },
    'imap_settings' => {
        datatype => 'CreateConnectorImapOptions',
        base_name => 'imapSettings',
        description => '',
        format => '',
        read_only => '',
            },
    ...
    'sync_interval' => {
        datatype => 'int',
        base_name => 'syncInterval',
        description => '',
        format => '',
        read_only => '',
            },
    'fetch_settings' => {
        datatype => 'CreateConnectorImapFetchOptions',
        base_name => 'fetchSettings',
        description => '',
        format => '',
        read_only => '',
            },
