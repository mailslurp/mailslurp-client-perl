...
#
package MailSlurp::Object::EmailPreviewUrls;
...
__PACKAGE__->class_documentation({description => 'URLs for email body',
                                  class => 'EmailPreviewUrls',
                                  required => [], # TODO
}                                 );

__PACKAGE__->method_documentation({
    'raw_smtp_message_url' => {
        datatype => 'string',
        base_name => 'rawSmtpMessageUrl',
        description => '',
        format => '',
        read_only => '',
            },
