...
#
package MailSlurp::Object::PageAlias;
...
__PACKAGE__->class_documentation({description => 'Paginated email alias results. Page index starts at zero. Projection results may omit larger entity fields. For fetching a full inbox entity use the projection ID with individual method calls.',
                                  class => 'PageAlias',
                                  required => [], # TODO
}                                 );
...
__PACKAGE__->method_documentation({
    'content' => {
        datatype => 'ARRAY[AliasProjection]',
        base_name => 'content',
        description => '',
        format => '',
        read_only => '',
