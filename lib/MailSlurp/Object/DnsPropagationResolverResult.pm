...
#
package MailSlurp::Object::DnsPropagationResolverResult;
...
__PACKAGE__->class_documentation({description => 'Propagation results from a single DNS resolver',
...
__PACKAGE__->method_documentation({
    ...
    'matched_expected_value' => {
        datatype => 'boolean',
        base_name => 'matchedExpectedValue',
        description => '',
        format => '',
        read_only => '',
            },
