...
__PACKAGE__->method_documentation({
    'base64_contents' => {
        ...
        description => 'Base64 encoded string of file contents. Typically this means reading the bytes or string content of a file and then converting that to a base64 encoded string.',
        format => '',
        read_only => '',
            },
    'content_type' => {
