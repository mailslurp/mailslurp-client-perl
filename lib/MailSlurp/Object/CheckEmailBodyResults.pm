...
#
package MailSlurp::Object::CheckEmailBodyResults;
...
__PACKAGE__->method_documentation({
    ...
    'link_issues' => {
        datatype => 'ARRAY[LinkIssue]',
        base_name => 'linkIssues',
        description => '',
        format => '',
        read_only => '',
            },
    'image_issues' => {
        datatype => 'ARRAY[ImageIssue]',
        base_name => 'imageIssues',
        description => '',
        format => '',
        read_only => '',
            },
    'spelling_issues' => {
        datatype => 'ARRAY[SpellingIssue]',
