...
#
package MailSlurp::Object::EmailAuditSpellingIssue;
...
__PACKAGE__->class_documentation({description => 'A single spelling or content-quality issue discovered during email audit checks',
