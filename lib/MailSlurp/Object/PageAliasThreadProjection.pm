...
#
package MailSlurp::Object::PageAliasThreadProjection;
...
__PACKAGE__->class_documentation({description => 'Paginated alias thread projection results.',
...
__PACKAGE__->method_documentation({
    'content' => {
        datatype => 'ARRAY[AliasThreadProjection]',
        base_name => 'content',
        description => '',
        format => '',
        read_only => '',
