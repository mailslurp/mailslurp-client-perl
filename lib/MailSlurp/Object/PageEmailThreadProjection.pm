...
#
package MailSlurp::Object::PageEmailThreadProjection;
...
__PACKAGE__->class_documentation({description => 'Paginated email thread projection results.',
...
__PACKAGE__->method_documentation({
    'content' => {
        datatype => 'ARRAY[EmailThreadProjection]',
        base_name => 'content',
        description => '',
        format => '',
        read_only => '',
