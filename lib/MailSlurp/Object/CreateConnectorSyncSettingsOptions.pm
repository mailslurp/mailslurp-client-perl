...
#
package MailSlurp::Object::CreateConnectorSyncSettingsOptions;
...
__PACKAGE__->class_documentation({description => 'Options for creating automatic syncing between an inbox connection and an external mail provider',
