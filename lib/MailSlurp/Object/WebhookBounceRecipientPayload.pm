...
#
package MailSlurp::Object::WebhookBounceRecipientPayload;
...
__PACKAGE__->class_documentation({description => 'BOUNCE_RECIPIENT webhook payload. Sent to your webhook url endpoint via HTTP POST when an email caused a bounce to occur for a recipient. Save the recipient to a ban list of your server and avoid email them again.',
...
__PACKAGE__->method_documentation({
    ...
    'recipient' => {
        datatype => 'string',
        base_name => 'recipient',
        description => 'Email address that caused a bounce. Make note of the address and try not to message it again to preserve your reputation.',
        format => '',
        read_only => '',
            },
});
