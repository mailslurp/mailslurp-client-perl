...
#
package MailSlurp::Object::ValidateEmailAddressListOptions;
...
__PACKAGE__->class_documentation({description => 'Options for validating a list of email addresses',
