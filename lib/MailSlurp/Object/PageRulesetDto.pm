...
#
package MailSlurp::Object::PageRulesetDto;
...
__PACKAGE__->class_documentation({description => 'Paginated ruleset results to deny or permit inbound or outbound SMS and email. Page index starts at zero. Projection results may omit larger entity fields. For fetching a full entity use the projection ID with individual method calls.',
