...
#
package MailSlurp::Object::PageInboxTags;
...
__PACKAGE__->class_documentation({description => 'Paginated inbox tags. Page index starts at zero. Projection results may omit larger entity fields. For fetching a full entity use the projection ID with individual method calls.',
                                  class => 'PageInboxTags',
                                  required => [], # TODO
}                                 );
