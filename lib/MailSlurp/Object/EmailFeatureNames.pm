...
#
package MailSlurp::Object::EmailFeatureNames;
...
__PACKAGE__->method_documentation({
    'family' => {
        datatype => 'ARRAY[EmailFeatureFamilyName]',
        base_name => 'family',
        description => '',
        format => '',
        read_only => '',
    ...
    'platform' => {
        datatype => 'ARRAY[EmailFeaturePlatformName]',
        base_name => 'platform',
        description => '',
        format => '',
        read_only => '',
    ...
    'category' => {
        datatype => 'ARRAY[EmailFeatureCategoryName]',
        base_name => 'category',
        description => '',
        format => '',
        read_only => '',
