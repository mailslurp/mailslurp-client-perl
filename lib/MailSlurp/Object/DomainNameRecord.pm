...
#
package MailSlurp::Object::DomainNameRecord;
...
__PACKAGE__->class_documentation({description => 'DNS Record required for verification of a domain. Record vary depending on domain type.',
...
__PACKAGE__->method_documentation({
    ...
    'alternative_record_entries' => {
        datatype => 'ARRAY[string]',
        base_name => 'alternativeRecordEntries',
        description => '',
        format => '',
        read_only => '',
            },
