...
#
package MailSlurp::Object::FilterBouncedRecipientsResult;
...
__PACKAGE__->class_documentation({description => 'Remaining recipients that were filtered to remove bounced recipients',
