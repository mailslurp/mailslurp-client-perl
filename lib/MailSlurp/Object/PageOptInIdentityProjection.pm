...
#
package MailSlurp::Object::PageOptInIdentityProjection;
...
__PACKAGE__->class_documentation({description => 'Paginated opt in identity projections reflecting users who have verified double-opt in consent to receive emails from your account.',
...
__PACKAGE__->method_documentation({
    'content' => {
        datatype => 'ARRAY[OptInIdentityProjection]',
        base_name => 'content',
        description => '',
        format => '',
        read_only => '',
