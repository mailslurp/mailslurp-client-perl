...
#
package MailSlurp::Object::AttachmentEntityDto;
...
__PACKAGE__->class_documentation({description => 'DTO representation of an attachment.',
...
__PACKAGE__->method_documentation({
    ...
    'content_id' => {
        datatype => 'string',
        base_name => 'contentId',
        description => 'The content identifier, which is a unique ID for the content part of the email.',
        format => '',
        read_only => '',
            },
    'name' => {
