...
#
package MailSlurp::Object::ValidateEmailAddressListResult;
...
__PACKAGE__->class_documentation({description => 'Result of validating a list of email addresses',
...
__PACKAGE__->method_documentation({
    ...
    'invalid_email_addresses' => {
        datatype => 'ARRAY[string]',
        base_name => 'invalidEmailAddresses',
        description => '',
        format => '',
        read_only => '',
            },
    'result_map_email_address_is_valid' => {
        ...
        base_name => 'resultMapEmailAddressIsValid',
        description => '',
        format => '',
        read_only => '',
            },
