...
#
package MailSlurp::Object::ImapSmtpAccessServers;
...
__PACKAGE__->class_documentation({description => 'IMAP and SMTP server endpoints for MailSlurp',
...
__PACKAGE__->method_documentation({
    'imap_server' => {
        datatype => 'ServerEndpoints',
        base_name => 'imapServer',
        description => '',
        format => '',
        read_only => '',
            },
