...
#
package MailSlurp::Object::PageGroupProjection;
...
__PACKAGE__->class_documentation({description => 'Paginated contact group results. Page index starts at zero. Projection results may omit larger entity fields. For fetching a full inbox entity use the projection ID with individual method calls.',
...
__PACKAGE__->method_documentation({
    'content' => {
        datatype => 'ARRAY[GroupProjection]',
        base_name => 'content',
        description => '',
        format => '',
        read_only => '',
