...
#
package MailSlurp::Object::ImapAccessDetails;
...
__PACKAGE__->class_documentation({description => 'Access details for inbox using IMAP',
                                  class => 'ImapAccessDetails',
                                  required => [], # TODO
}                                 );

__PACKAGE__->method_documentation({
    'secure_imap_server_host' => {
        datatype => 'string',
        base_name => 'secureImapServerHost',
    ...
    'secure_imap_server_port' => {
        datatype => 'int',
        base_name => 'secureImapServerPort',
        description => 'Secure TLS IMAP server host port',
        format => '',
        read_only => '',
            },
    'secure_imap_username' => {
        datatype => 'string',
        base_name => 'secureImapUsername',
        description => 'Secure TLS IMAP username for login',
        format => '',
        read_only => '',
            },
    'secure_imap_password' => {
        datatype => 'string',
        base_name => 'secureImapPassword',
