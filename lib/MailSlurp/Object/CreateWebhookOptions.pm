...
__PACKAGE__->method_documentation({
    ...
    'event_name' => {
        datatype => 'string',
        base_name => 'eventName',
        description => 'Optional webhook event name. Default is &#x60;EMAIL_RECEIVED&#x60; and is triggered when an email is received by the inbox associated with the webhook. Payload differ according to the webhook event name. The other events are &#x60;NEW_EMAIL&#x60;, &#x60;NEW_CONTACT&#x60;, and &#x60;NEW_ATTACHMENT&#x60;.',
        format => '',
        read_only => '',
            },
    'name' => {
