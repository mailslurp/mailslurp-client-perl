...
__PACKAGE__->method_documentation({
    ...
    'event_name' => {
        datatype => 'string',
        base_name => 'eventName',
        description => 'Optional webhook event name. Default is &#x60;EMAIL_RECEIVED&#x60;. Payload differ according to the webhook event name.',
        format => '',
        read_only => '',
            },
    'name' => {
    ...
    'url' => {
        datatype => 'string',
        base_name => 'url',
        description => 'Public URL on your server that MailSlurp can post WebhookNotification payload to when an email is received. The payload of the submitted JSON is described by https://api.mailslurp.com/schemas/webhook-payload',
        format => '',
        read_only => '',
            },
});
