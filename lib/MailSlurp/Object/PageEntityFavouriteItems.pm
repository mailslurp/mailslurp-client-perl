...
#
package MailSlurp::Object::PageEntityFavouriteItems;
...
__PACKAGE__->class_documentation({description => 'Paginated favourite items like inboxes, phones, sms, emails. Page index starts at zero. Projection results may omit larger entity fields. For fetching a full entity use the projection ID with individual method calls.',
...
__PACKAGE__->method_documentation({
    'content' => {
        datatype => 'ARRAY[EntityFavouriteItemProjection]',
        base_name => 'content',
        description => '',
        format => '',
        read_only => '',
