...
#
package MailSlurp::Object::EmailRecipientsProjection;
...
__PACKAGE__->class_documentation({description => 'Recipients of original email in thread',
...
__PACKAGE__->method_documentation({
    'to' => {
        datatype => 'ARRAY[RecipientProjection]',
        base_name => 'to',
        description => '',
        format => '',
        read_only => '',
