...
#
package MailSlurp::Object::CreateConnectorWithOptions;
...
__PACKAGE__->class_documentation({description => 'Options for creating an inbox connection with an external mail provider including extra settings',
...
__PACKAGE__->method_documentation({
    'create_connector_options' => {
        datatype => 'CreateConnectorOptions',
        base_name => 'createConnectorOptions',
        description => '',
        format => '',
        read_only => '',
            },
    'create_connector_imap_connection_options' => {
        datatype => 'CreateConnectorImapConnectionOptions',
        base_name => 'createConnectorImapConnectionOptions',
        description => '',
        format => '',
        read_only => '',
            },
    'create_connector_smtp_connection_options' => {
        datatype => 'CreateConnectorSmtpConnectionOptions',
        base_name => 'createConnectorSmtpConnectionOptions',
        description => '',
        format => '',
        read_only => '',
            },
    'create_connector_sync_settings_options' => {
        datatype => 'CreateConnectorSyncSettingsOptions',
        base_name => 'createConnectorSyncSettingsOptions',
        description => '',
        format => '',
        read_only => '',
            },
