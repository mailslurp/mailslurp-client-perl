...
#
package MailSlurp::Object::PagePlusAddressProjection;
...
__PACKAGE__->class_documentation({description => 'Paginated inbox plus addresses. Page index starts at zero. Projection results may omit larger entity fields. For fetching a full entity use the projection ID with individual method calls.',
...
__PACKAGE__->method_documentation({
    'content' => {
        datatype => 'ARRAY[PlusAddressProjection]',
        base_name => 'content',
        description => '',
        format => '',
        read_only => '',
