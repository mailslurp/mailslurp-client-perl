...
#
package MailSlurp::Object::PageConnector;
...
__PACKAGE__->class_documentation({description => 'Paginated inbox connectors. Page index starts at zero. Projection results may omit larger entity fields. For fetching a full entity use the projection ID with individual method calls.',
                                  class => 'PageConnector',
                                  required => [], # TODO
}                                 );
...
__PACKAGE__->method_documentation({
    'content' => {
        datatype => 'ARRAY[ConnectorProjection]',
        base_name => 'content',
        description => '',
        format => '',
        read_only => '',
