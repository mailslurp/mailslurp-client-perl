...
#
package MailSlurp::Object::GenerateStructuredContentEmailOptions;
...
__PACKAGE__->class_documentation({description => 'Options for generating structured content output from an email',
...
__PACKAGE__->method_documentation({
    ...
    'instructions' => {
        ...
        description => 'Optional instructions for the AI to follow. Try to be precise and clear. You can include examples and hints.',
        format => '',
        read_only => '',
            },
    'output_schema' => {
        datatype => 'StructuredOutputSchema',
        base_name => 'outputSchema',
        description => '',
        format => '',
        read_only => '',
            },
