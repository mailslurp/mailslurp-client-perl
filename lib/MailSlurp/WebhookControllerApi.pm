...
# 
# @param string $transformer_id  (required)
# @param CreateWebhookOptions $create_webhook_options  (required)
{
    my $params = {
    'transformer_id' => {
    ...
    __PACKAGE__->method_documentation->{ 'create_webhook_for_ai_transformer' } = { 
        summary => 'Attach a WebHook URL to an AI transformer',
        params => $params,
        returns => 'WebhookDto',
        };
}
# @return WebhookDto
#
sub create_webhook_for_ai_transformer {
    my ($self, %args) = @_;

    # verify the required parameter 'transformer_id' is set
    unless (exists $args{'transformer_id'}) {
      croak("Missing the required parameter 'transformer_id' when calling create_webhook_for_ai_transformer");
    }

    # verify the required parameter 'create_webhook_options' is set
    unless (exists $args{'create_webhook_options'}) {
      croak("Missing the required parameter 'create_webhook_options' when calling create_webhook_for_ai_transformer");
    }

    # parse inputs
    my $_resource_path = '/ai-transformers/{transformerId}/webhooks';
    ...
    # path params
    if ( exists $args{'transformer_id'}) {
        my $_base_variable = "{" . "transformerId" . "}";
        my $_base_value = $self->{api_client}->to_path_value($args{'transformer_id'});
        $_resource_path =~ s/$_base_variable/$_base_value/g;
    }
...
# @param string $ai_transformer_id AI Transformer ID (optional)
{
    my $params = {
    'page' => {
        data_type => 'int',
...
sub get_all_webhook_results {
    ...
    # query params
    if ( exists $args{'ai_transformer_id'}) {
        $query_params->{'aiTransformerId'} = $self->{api_client}->to_query_value($args{'ai_transformer_id'});
    }
...
# @param DateTime $since Filter by created at after the given timestamp (optional)
# @param string $inbox_id Filter by inboxId (optional)
# @param string $ai_transformer_id Filter by aiTransformerId (optional)
# @param string $phone_id Filter by phoneId (optional)
# @param DateTime $before Filter by created at before the given timestamp (optional)
# @param string $health Filter by webhook health (optional)
# @param string $event_type Optional event type (optional)
# @param string $url Optional url endpoint filter (optional)
# @param string $event_type_source Webhook source type category such as phone, inbox, aiTranformer (optional)
# @param boolean $include_account_wide Include account scope webhooks when passing phoneId, inboxId, or aiTransformerId filters (optional)
{
    my $params = {
    'page' => {
        data_type => 'int',
    ...
    'ai_transformer_id' => {
        data_type => 'string',
        description => 'Filter by aiTransformerId',
        required => '0',
    },
    'phone_id' => {
        data_type => 'string',
    ...
    'event_type_source' => {
        data_type => 'string',
        description => 'Webhook source type category such as phone, inbox, aiTranformer',
        required => '0',
    },
    'include_account_wide' => {
        data_type => 'boolean',
        description => 'Include account scope webhooks when passing phoneId, inboxId, or aiTransformerId filters',
        required => '0',
    },
    };
...
sub get_all_webhooks {
    ...
    # query params
    if ( exists $args{'event_type_source'}) {
        $query_params->{'eventTypeSource'} = $self->{api_client}->to_query_value($args{'event_type_source'});
    }

    # query params
    if ( exists $args{'include_account_wide'}) {
        $query_params->{'includeAccountWide'} = $self->{api_client}->to_query_value($args{'include_account_wide'});
    }
...
# @param string $health Filter by webhook health (optional)
# @param string $event_type Optional event type (optional)
# @param boolean $include_account_wide Include account scope inbox webhooks (optional)
{
    my $params = {
    'inbox_id' => {
        data_type => 'string',
    ...
    'include_account_wide' => {
        data_type => 'boolean',
        description => 'Include account scope inbox webhooks',
        required => '0',
    },
    };
...
# @param string $search_filter Optional search filter (optional)
# @param string $health Filter by webhook health (optional)
# @param boolean $include_account_wide Include account scope phone webhooks (optional)
{
    my $params = {
    'phone_id' => {
        data_type => 'string',
    ...
    'include_account_wide' => {
        data_type => 'boolean',
        description => 'Include account scope phone webhooks',
        required => '0',
    },
    };
...
# 
{
    ...
    __PACKAGE__->method_documentation->{ 'get_test_webhook_payload_new_ai_transform_result' } = { 
        summary => 'Get webhook test payload for new ai transform result event',
        params => $params,
        returns => 'WebhookNewAITransformResultPayload',
        };
}
# @return WebhookNewAITransformResultPayload
#
sub get_test_webhook_payload_new_ai_transform_result {
    my ($self, %args) = @_;

    # parse inputs
    my $_resource_path = '/webhooks/test/new-ai-transform-result-payload';
    ...
    my $_response_object = $self->{api_client}->deserialize('WebhookNewAITransformResultPayload', $response);
    return $_response_object;
}
...
# @param string $ai_transformer_id  (optional)
