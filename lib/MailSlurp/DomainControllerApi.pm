...
sub create_domain {
    ...
    unless (exists $args{'create_domain_options'}) {
      croak("Missing the required parameter 'create_domain_options' when calling create_domain");
    }
    ...
    my $_body_data;
    # body params
    if ( exists $args{'create_domain_options'}) {
        $_body_data = $args{'create_domain_options'};
    }
...
# @param string $inbox_type  (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'get_available_domain_regions' } = { 
        summary => 'Get all usable domains with account region status',
        params => $params,
        returns => 'DomainRegionGroupsDto',
        };
}
# @return DomainRegionGroupsDto
#
sub get_available_domain_regions {
    my ($self, %args) = @_;

    # parse inputs
    my $_resource_path = '/domains/available-domain-regions';
    ...
    my $_response_object = $self->{api_client}->deserialize('DomainRegionGroupsDto', $response);
    return $_response_object;
}
...
# @param string $inbox_type  (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'get_available_domains' } = { 
        summary => 'Get all usable domains',
        params => $params,
        returns => 'DomainGroupsDto',
        };
}
...
sub get_available_domains {
    ...
    # parse inputs
    my $_resource_path = '/domains/available-domains';
    ...
    my $_response_object = $self->{api_client}->deserialize('DomainGroupsDto', $response);
    return $_response_object;
}
...
# 
# @param string $id  (required)
# @param boolean $check_for_errors  (optional)
{
    my $params = {
    'id' => {
        data_type => 'string',
...
sub get_domain {
    ...
    # query params
    if ( exists $args{'check_for_errors'}) {
        $query_params->{'checkForErrors'} = $self->{api_client}->to_query_value($args{'check_for_errors'});
    }
...
# 
{
    ...
    __PACKAGE__->method_documentation->{ 'get_domain_issues' } = { 
        summary => 'Get domain issues',
        params => $params,
        returns => 'DomainIssuesDto',
        };
}
# @return DomainIssuesDto
#
sub get_domain_issues {
    my ($self, %args) = @_;

    # parse inputs
    my $_resource_path = '/domains/issues';
    ...
    my $_response_object = $self->{api_client}->deserialize('DomainIssuesDto', $response);
    return $_response_object;
}
...
# @param string $id  (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'get_domain_wildcard_catch_all_inbox' } = { 
...
# @return InboxDto
#
sub get_domain_wildcard_catch_all_inbox {
    my ($self, %args) = @_;

    # verify the required parameter 'id' is set
    unless (exists $args{'id'}) {
      croak("Missing the required parameter 'id' when calling get_domain_wildcard_catch_all_inbox");
    }
...
# @param string $inbox_type  (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'get_mail_slurp_domains' } = { 
...
# @return DomainGroupsDto
#
sub get_mail_slurp_domains {
    my ($self, %args) = @_;

    # parse inputs
    my $_resource_path = '/domains/mailslurp-domains';
...
sub update_domain {
    ...
    unless (exists $args{'update_domain_options'}) {
      croak("Missing the required parameter 'update_domain_options' when calling update_domain");
    }
    ...
    my $_body_data;
    # body params
    if ( exists $args{'update_domain_options'}) {
        $_body_data = $args{'update_domain_options'};
    }
