...
has _cfg => ( is => 'ro',
              isa => 'MailSlurp::Configuration',
              default => sub { MailSlurp::Configuration->new() },
              );

has version_info => ( is => 'ro',
                      isa => 'HashRef',
                      default => sub { {
                          app_name => 'MailSlurp API',
                          app_version => '6.5.2',
...
sub _build_af {
    ...
    return MailSlurp::ApiFactory->new(%args);
}

=head1 NAME

MailSlurp::Role - a Moose role for the MailSlurp API

=head2 MailSlurp API version: 6.5.2
...
MailSlurp::ApiFactory for non-Moosey usage.
...
The tokens will be placed in a L<MailSlurp::Configuration> instance
...
Returns an API factory object. You probably won't need to call this directly.
        ...
        $self->api_factory('Pet'); # returns a MailSlurp::PetApi instance
