...
# 
# @param string $id_of_the_expired_inbox_record_you_want_to_retrieve/_this_is_different_from_the_id_of_the_inbox_you_are_interested_in/_see_other_methods_for_getting_expired_inbox_record_for_an_inbox_inbox_id)  (required)
{
    my $params = {
    'id_of_the_expired_inbox_record_you_want_to_retrieve/_this_is_different_from_the_id_of_the_inbox_you_are_interested_in/_see_other_methods_for_getting_expired_inbox_record_for_an_inbox_inbox_id)' => {
        data_type => 'string',
        description => '',
        required => '1',
    },
...
sub get_expired_inbox_record {
    ...
    # verify the required parameter 'id_of_the_expired_inbox_record_you_want_to_retrieve/_this_is_different_from_the_id_of_the_inbox_you_are_interested_in/_see_other_methods_for_getting_expired_inbox_record_for_an_inbox_inbox_id)' is set
    unless (exists $args{'id_of_the_expired_inbox_record_you_want_to_retrieve/_this_is_different_from_the_id_of_the_inbox_you_are_interested_in/_see_other_methods_for_getting_expired_inbox_record_for_an_inbox_inbox_id)'}) {
      croak("Missing the required parameter 'id_of_the_expired_inbox_record_you_want_to_retrieve/_this_is_different_from_the_id_of_the_inbox_you_are_interested_in/_see_other_methods_for_getting_expired_inbox_record_for_an_inbox_inbox_id)' when calling get_expired_inbox_record");
    }
    ...
    # path params
    if ( exists $args{'id_of_the_expired_inbox_record_you_want_to_retrieve/_this_is_different_from_the_id_of_the_inbox_you_are_interested_in/_see_other_methods_for_getting_expired_inbox_record_for_an_inbox_inbox_id)'}) {
        my $_base_variable = "{" . "ID of the ExpiredInboxRecord you want to retrieve. This is different from the ID of the inbox you are interested in. See other methods for getting ExpiredInboxRecord for an inbox inboxId)" . "}";
        my $_base_value = $self->{api_client}->to_path_value($args{'id_of_the_expired_inbox_record_you_want_to_retrieve/_this_is_different_from_the_id_of_the_inbox_you_are_interested_in/_see_other_methods_for_getting_expired_inbox_record_for_an_inbox_inbox_id)'});
        $_resource_path =~ s/$_base_variable/$_base_value/g;
    }
