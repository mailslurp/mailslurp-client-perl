...
sub wait_for_nth_missed_email {
    ...
    unless (exists $args{'inbox_id'}) {
      croak("Missing the required parameter 'inbox_id' when calling wait_for_nth_missed_email");
    }

    # verify the required parameter 'timeout' is set
    unless (exists $args{'timeout'}) {
      croak("Missing the required parameter 'timeout' when calling wait_for_nth_missed_email");
    }
    ...
    if ( exists $args{'timeout'}) {
        my $_base_variable = "{" . "timeout" . "}";
        my $_base_value = $self->{api_client}->to_path_value($args{'timeout'});
        $_resource_path =~ s/$_base_variable/$_base_value/g;
    }
