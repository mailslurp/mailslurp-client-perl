...
# @param string $export_type exportType (required)
# @param string $output_format outputFormat (required)
# @param DateTime $created_earliest_time createdEarliestTime (optional)
# @param DateTime $created_oldest_time createdOldestTime (optional)
# @param boolean $exclude_previously_exported excludePreviouslyExported (optional)
# @param string $filter filter (optional)
# @param string $list_separator_token listSeparatorToken (optional)
{
    my $params = {
    'api_key' => {
        data_type => 'string',
...
# @param string $api_key apiKey (optional)
{
    my $params = {
    'export_type' => {
        data_type => 'string',
