...
# @param DateTime $before Optional filter by sent before given date time (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'get_alias_threads' } = { 
        ...
        params => $params,
        returns => 'PageAliasThreadProjection',
        };
}
...
sub get_alias_threads {
    ...
    my $_response_object = $self->{api_client}->deserialize('PageAliasThreadProjection', $response);
    return $_response_object;
}
...
sub get_thread {
    ...
    # parse inputs
    my $_resource_path = '/aliases/threads/{threadId}';
    ...
    my $_response_object = $self->{api_client}->deserialize('AliasThreadProjection', $response);
    return $_response_object;
}
...
# @param DateTime $before Optional filter by sent before given date time (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'get_threads_paginated' } = { 
...
# @return PageAliasThreadProjection
#
sub get_threads_paginated {
    my ($self, %args) = @_;

    # parse inputs
    my $_resource_path = '/aliases/threads';
