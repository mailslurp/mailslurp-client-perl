...
# @param CreateInboxRetentionPolicyForAccountOptions $create_inbox_retention_policy_for_account_options  (required)
{
    ...
    'create_inbox_retention_policy_for_account_options' => {
        data_type => 'CreateInboxRetentionPolicyForAccountOptions',
        description => '',
        required => '1',
    },
    };
    __PACKAGE__->method_documentation->{ 'create_or_update_inbox_retention_policy_for_account' } = { 
        summary => '',
        params => $params,
        returns => 'InboxRetentionPolicyDto',
        };
}
# @return InboxRetentionPolicyDto
#
sub create_or_update_inbox_retention_policy_for_account {
    my ($self, %args) = @_;

    # verify the required parameter 'create_inbox_retention_policy_for_account_options' is set
    unless (exists $args{'create_inbox_retention_policy_for_account_options'}) {
      croak("Missing the required parameter 'create_inbox_retention_policy_for_account_options' when calling create_or_update_inbox_retention_policy_for_account");
    }

    # parse inputs
    my $_resource_path = '/user/inbox-retention-policies/account';
    ...
    my $_body_data;
    # body params
    if ( exists $args{'create_inbox_retention_policy_for_account_options'}) {
        $_body_data = $args{'create_inbox_retention_policy_for_account_options'};
    }
    ...
    my $_response_object = $self->{api_client}->deserialize('InboxRetentionPolicyDto', $response);
...
# 
{
    ...
    __PACKAGE__->method_documentation->{ 'delete_inbox_retention_policy_for_account' } = { 
        summary => '',
        params => $params,
...
#
sub delete_inbox_retention_policy_for_account {
    my ($self, %args) = @_;
...
# 
{
    ...
    __PACKAGE__->method_documentation->{ 'get_inbox_retention_policy_for_account' } = { 
        summary => '',
        params => $params,
        returns => 'InboxRetentionPolicyOptionalDto',
        };
}
# @return InboxRetentionPolicyOptionalDto
#
sub get_inbox_retention_policy_for_account {
    my ($self, %args) = @_;
    ...
    my $_response_object = $self->{api_client}->deserialize('InboxRetentionPolicyOptionalDto', $response);
    return $_response_object;
}
