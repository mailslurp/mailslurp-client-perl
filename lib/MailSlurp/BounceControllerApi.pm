...
# @param DateTime $before Filter by created at before the given timestamp (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'get_reputation_items' } = { 
        summary => 'Get paginated list of reputation items.',
        params => $params,
        returns => 'PageReputationItems',
        };
}
# @return PageReputationItems
#
sub get_reputation_items {
    my ($self, %args) = @_;

    # parse inputs
    my $_resource_path = '/bounce/reputation-items';
    ...
    my $_response_object = $self->{api_client}->deserialize('PageReputationItems', $response);
    return $_response_object;
}
...
# 
# @param string $account_region Optional account region filter (optional)
{
    my $params = {
    'account_region' => {
        data_type => 'string',
        description => 'Optional account region filter',
        required => '0',
    },
    };
    __PACKAGE__->method_documentation->{ 'get_tenant_reputation_findings' } = { 
        summary => 'Get SES tenant reputation findings',
        params => $params,
        returns => 'TenantReputationFindingsDto',
        };
}
# @return TenantReputationFindingsDto
#
sub get_tenant_reputation_findings {
    my ($self, %args) = @_;

    # parse inputs
    my $_resource_path = '/bounce/tenant-findings';
    ...
    # query params
    if ( exists $args{'account_region'}) {
        $query_params->{'accountRegion'} = $self->{api_client}->to_query_value($args{'account_region'});
    }
    ...
    my $_response_object = $self->{api_client}->deserialize('TenantReputationFindingsDto', $response);
    return $_response_object;
}
...
# @param string $account_region Optional account region filter (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'get_tenant_reputation_status_summary' } = { 
        summary => 'Get SES tenant status summary',
        params => $params,
        returns => 'TenantReputationStatusSummaryDto',
        };
}
# @return TenantReputationStatusSummaryDto
#
sub get_tenant_reputation_status_summary {
    my ($self, %args) = @_;

    # parse inputs
    my $_resource_path = '/bounce/tenant-status';
    ...
    my $_response_object = $self->{api_client}->deserialize('TenantReputationStatusSummaryDto', $response);
    return $_response_object;
}
