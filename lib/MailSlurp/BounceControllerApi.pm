...
sub get_bounced_email {
    ...
    my $_response_object = $self->{api_client}->deserialize('Bounce', $response);
...
sub get_bounced_recipient {
    ...
    my $_response_object = $self->{api_client}->deserialize('BounceRecipient', $response);
    return $_response_object;
}
