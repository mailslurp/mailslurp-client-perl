...
# 
# @param ExportTransformerOptions $export_transformer_options  (required)
{
    my $params = {
    'export_transformer_options' => {
        data_type => 'ExportTransformerOptions',
        description => '',
        required => '1',
    },
    };
    __PACKAGE__->method_documentation->{ 'export_transformer_results' } = { 
        summary => 'Export transformer results',
        params => $params,
        returns => 'ExportTransformerResponse',
        };
}
# @return ExportTransformerResponse
#
sub export_transformer_results {
    my ($self, %args) = @_;

    # verify the required parameter 'export_transformer_options' is set
    unless (exists $args{'export_transformer_options'}) {
      croak("Missing the required parameter 'export_transformer_options' when calling export_transformer_results");
    }

    # parse inputs
    my $_resource_path = '/ai/transformer/results/export';
    ...
    my $_body_data;
    # body params
    if ( exists $args{'export_transformer_options'}) {
        $_body_data = $args{'export_transformer_options'};
    }
    ...
    my $_response_object = $self->{api_client}->deserialize('ExportTransformerResponse', $response);
    return $_response_object;
}
...
# @param string $id  (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'get_export_transformer_results_job' } = { 
        summary => 'Get export transformer results job',
        params => $params,
        returns => 'ExportTransformerResultJobDto',
        };
}
# @return ExportTransformerResultJobDto
#
sub get_export_transformer_results_job {
    my ($self, %args) = @_;

    # verify the required parameter 'id' is set
    unless (exists $args{'id'}) {
      croak("Missing the required parameter 'id' when calling get_export_transformer_results_job");
    }

    # parse inputs
    my $_resource_path = '/ai/transformer/results/export/{id}';
    ...
    my $_response_object = $self->{api_client}->deserialize('ExportTransformerResultJobDto', $response);
    return $_response_object;
}
...
# @param string $sms_id  (optional)
# @param string $attachment_id  (optional)
# @param string $ai_transform_id  (optional)
...
# 
# @param boolean $include_meta_data  (required)
# @param boolean $flatten_arrays_to_rows  (required)
# @param string $email_id  (optional)
# @param string $sms_id  (optional)
# @param string $attachment_id  (optional)
# @param string $ai_transform_id  (optional)
...
# @param string $sort Optional createdAt sort direction ASC or DESC (optional, default to 'ASC')
{
    ...
    __PACKAGE__->method_documentation->{ 'get_transformer_results_table' } = { 
        summary => 'Get transformer results table',
        params => $params,
        returns => 'PageTableData',
        };
}
# @return PageTableData
#
sub get_transformer_results_table {
    my ($self, %args) = @_;

    # verify the required parameter 'include_meta_data' is set
    unless (exists $args{'include_meta_data'}) {
      croak("Missing the required parameter 'include_meta_data' when calling get_transformer_results_table");
    }

    # verify the required parameter 'flatten_arrays_to_rows' is set
    unless (exists $args{'flatten_arrays_to_rows'}) {
      croak("Missing the required parameter 'flatten_arrays_to_rows' when calling get_transformer_results_table");
    }

    # parse inputs
    my $_resource_path = '/ai/transformer/results/table';
    ...
    # query params
    if ( exists $args{'include_meta_data'}) {
        $query_params->{'includeMetaData'} = $self->{api_client}->to_query_value($args{'include_meta_data'});
    }

    # query params
    if ( exists $args{'flatten_arrays_to_rows'}) {
        $query_params->{'flattenArraysToRows'} = $self->{api_client}->to_query_value($args{'flatten_arrays_to_rows'});
    }
    ...
    my $_response_object = $self->{api_client}->deserialize('PageTableData', $response);
    return $_response_object;
}
...
# @param string $attachment_id  (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'test_transformer_mapping_match' } = { 
        summary => 'Test transformer mapping match result',
        params => $params,
        returns => 'AITransformMappingMatchResult',
        };
}
# @return AITransformMappingMatchResult
#
sub test_transformer_mapping_match {
    my ($self, %args) = @_;

    # verify the required parameter 'id' is set
    unless (exists $args{'id'}) {
      croak("Missing the required parameter 'id' when calling test_transformer_mapping_match");
    }

    # parse inputs
    my $_resource_path = '/ai/transformer/mappings/{id}/match';
    ...
    my $_response_object = $self->{api_client}->deserialize('AITransformMappingMatchResult', $response);
    return $_response_object;
}
