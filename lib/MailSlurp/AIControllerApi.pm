...
# @param string $sort Optional createdAt sort direction ASC or DESC (optional, default to 'ASC')
{
    my $params = {
    'options' => {
        data_type => 'AITranformCreateOptions',
        description => '',
        required => '1',
    },
    'page' => {
...
sub create_transformer {
    ...
    unless (exists $args{'options'}) {
      croak("Missing the required parameter 'options' when calling create_transformer");
    }
...
# 
# @param AITranformCreateOptions $ai_tranform_create_options  (required)
{
    my $params = {
    'ai_tranform_create_options' => {
        data_type => 'AITranformCreateOptions',
        description => '',
        required => '1',
    },
    };
    __PACKAGE__->method_documentation->{ 'create_transformer1' } = { 
...
#
sub create_transformer1 {
    my ($self, %args) = @_;

    # verify the required parameter 'ai_tranform_create_options' is set
    unless (exists $args{'ai_tranform_create_options'}) {
      croak("Missing the required parameter 'ai_tranform_create_options' when calling create_transformer1");
    }
    ...
    my $_body_data;
    # body params
    if ( exists $args{'ai_tranform_create_options'}) {
        $_body_data = $args{'ai_tranform_create_options'};
    }
