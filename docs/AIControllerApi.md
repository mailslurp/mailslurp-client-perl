...
------------- | ------------- | -------------
[**create_transformer**](AIControllerApi#create_transformer) | **GET** /ai/transformer | List transformers
[**create_transformer1**](AIControllerApi#create_transformer1) | **POST** /ai/transformer | Create a transformer for reuse in automations
...
# **create_transformer**
> PageAITransformProjection create_transformer(options => $options, page => $page, size => $size, sort => $sort)
...
my $options = new MailSlurp.AITranformCreateOptions(); # AITranformCreateOptions | 
my $page = 0; # int | 
...
eval { 
    my $result = $api_instance->create_transformer(options => $options, page => $page, size => $size, sort => $sort);
    print Dumper($result);
};
if ($@) {
...
# **create_transformer1**
> AITransformDto create_transformer1(ai_tranform_create_options => $ai_tranform_create_options)
...
my $ai_tranform_create_options = MailSlurp::Object::AITranformCreateOptions->new(); # AITranformCreateOptions | 

eval { 
    my $result = $api_instance->create_transformer1(ai_tranform_create_options => $ai_tranform_create_options);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling AIControllerApi->create_transformer1: $@\n";
}
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **ai_tranform_create_options** | [**AITranformCreateOptions**](AITranformCreateOptions)|  | 
...
> PageAITransformResultProjection get_transformer_results(ai_transform_id => $ai_transform_id, ai_transform_mapping_id => $ai_transform_mapping_id, entity_id => $entity_id, entity_type => $entity_type, page => $page, size => $size, sort => $sort)
...
eval { 
    my $result = $api_instance->get_transformer_results(ai_transform_id => $ai_transform_id, ai_transform_mapping_id => $ai_transform_mapping_id, entity_id => $entity_id, entity_type => $entity_type, page => $page, size => $size, sort => $sort);
    print Dumper($result);
};
if ($@) {
