# MailSlurp::Object::CreateAliasOptions
...
**domain_id** | **string** | Custom domain ID to use when generating alias email addresses | [optional] 
**verify_email_address** | **boolean** | Whether to verify the masked email address exists before sending an email to it | [optional] 
