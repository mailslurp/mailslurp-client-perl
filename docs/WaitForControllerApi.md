...
> ARRAY[EmailPreview] wait_for_email_count(count => $count, delay => $delay, inbox_id => $inbox_id, since => $since, sort => $sort, timeout => $timeout, unread_only => $unread_only)
...
eval { 
    my $result = $api_instance->wait_for_email_count(count => $count, delay => $delay, inbox_id => $inbox_id, since => $since, sort => $sort, timeout => $timeout, unread_only => $unread_only);
    print Dumper($result);
};
if ($@) {
...
> Email wait_for_latest_email(delay => $delay, inbox_id => $inbox_id, since => $since, sort => $sort, timeout => $timeout, unread_only => $unread_only)
...
eval { 
    my $result = $api_instance->wait_for_latest_email(delay => $delay, inbox_id => $inbox_id, since => $since, sort => $sort, timeout => $timeout, unread_only => $unread_only);
    print Dumper($result);
};
if ($@) {
...
> ARRAY[EmailPreview] wait_for_matching_email(match_options => $match_options, count => $count, delay => $delay, inbox_id => $inbox_id, since => $since, sort => $sort, timeout => $timeout, unread_only => $unread_only)
...
eval { 
    my $result = $api_instance->wait_for_matching_email(match_options => $match_options, count => $count, delay => $delay, inbox_id => $inbox_id, since => $since, sort => $sort, timeout => $timeout, unread_only => $unread_only);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling WaitForControllerApi->wait_for_matching_email: $@\n";
}
```
...
> Email wait_for_matching_first_email(match_options => $match_options, delay => $delay, inbox_id => $inbox_id, since => $since, sort => $sort, timeout => $timeout, unread_only => $unread_only)
...
eval { 
    my $result = $api_instance->wait_for_matching_first_email(match_options => $match_options, delay => $delay, inbox_id => $inbox_id, since => $since, sort => $sort, timeout => $timeout, unread_only => $unread_only);
    print Dumper($result);
};
if ($@) {
...
# **wait_for_nth_email**
> Email wait_for_nth_email(delay => $delay, inbox_id => $inbox_id, index => $index, since => $since, sort => $sort, timeout => $timeout, unread_only => $unread_only)
...
eval { 
    my $result = $api_instance->wait_for_nth_email(delay => $delay, inbox_id => $inbox_id, index => $index, since => $since, sort => $sort, timeout => $timeout, unread_only => $unread_only);
    print Dumper($result);
};
if ($@) {
