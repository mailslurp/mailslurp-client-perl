...
> PageTrackingPixelProjection get_all_sent_tracking_pixels(before => $before, page => $page, search_filter => $search_filter, since => $since, size => $size, sort => $sort)
...
eval { 
    my $result = $api_instance->get_all_sent_tracking_pixels(before => $before, page => $page, search_filter => $search_filter, since => $since, size => $size, sort => $sort);
    print Dumper($result);
};
if ($@) {
...
> PageTrackingPixelProjection get_sent_email_tracking_pixels(id => $id, before => $before, page => $page, search_filter => $search_filter, since => $since, size => $size, sort => $sort)
...
eval { 
    my $result = $api_instance->get_sent_email_tracking_pixels(id => $id, before => $before, page => $page, search_filter => $search_filter, since => $since, size => $size, sort => $sort);
    print Dumper($result);
};
if ($@) {
...
# **get_sent_emails**
> PageSentEmailProjection get_sent_emails(before => $before, inbox_id => $inbox_id, page => $page, search_filter => $search_filter, since => $since, size => $size, sort => $sort)
...
eval { 
    my $result = $api_instance->get_sent_emails(before => $before, inbox_id => $inbox_id, page => $page, search_filter => $search_filter, since => $since, size => $size, sort => $sort);
    print Dumper($result);
};
if ($@) {
...
> PageSentEmailProjection get_sent_organization_emails(before => $before, inbox_id => $inbox_id, page => $page, search_filter => $search_filter, since => $since, size => $size, sort => $sort)
...
eval { 
    my $result = $api_instance->get_sent_organization_emails(before => $before, inbox_id => $inbox_id, page => $page, search_filter => $search_filter, since => $since, size => $size, sort => $sort);
    print Dumper($result);
};
if ($@) {
