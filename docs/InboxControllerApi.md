...
# **get_emails**
> ARRAY[EmailPreview] get_emails(inbox_id => $inbox_id, delay_timeout => $delay_timeout, limit => $limit, min_count => $min_count, retry_timeout => $retry_timeout, since => $since, size => $size, sort => $sort, unread_only => $unread_only)
...
eval { 
    my $result = $api_instance->get_emails(inbox_id => $inbox_id, delay_timeout => $delay_timeout, limit => $limit, min_count => $min_count, retry_timeout => $retry_timeout, since => $since, size => $size, sort => $sort, unread_only => $unread_only);
    print Dumper($result);
};
if ($@) {
...
> PageSentEmailProjection get_inbox_sent_emails(inbox_id => $inbox_id, page => $page, search_filter => $search_filter, size => $size, sort => $sort)
...
eval { 
    my $result = $api_instance->get_inbox_sent_emails(inbox_id => $inbox_id, page => $page, search_filter => $search_filter, size => $size, sort => $sort);
    print Dumper($result);
};
if ($@) {
...
> PageOrganizationInboxProjection get_organization_inboxes(page => $page, search_filter => $search_filter, size => $size, sort => $sort)
...
eval { 
    my $result = $api_instance->get_organization_inboxes(page => $page, search_filter => $search_filter, size => $size, sort => $sort);
    print Dumper($result);
};
if ($@) {
...
# **list_inbox_rulesets**
> PageInboxRulesetDto list_inbox_rulesets(inbox_id => $inbox_id, page => $page, search_filter => $search_filter, size => $size, sort => $sort)
...
eval { 
    my $result = $api_instance->list_inbox_rulesets(inbox_id => $inbox_id, page => $page, search_filter => $search_filter, size => $size, sort => $sort);
    print Dumper($result);
};
if ($@) {
...
> PageTrackingPixelProjection list_inbox_tracking_pixels(inbox_id => $inbox_id, page => $page, search_filter => $search_filter, size => $size, sort => $sort)
...
eval { 
    my $result = $api_instance->list_inbox_tracking_pixels(inbox_id => $inbox_id, page => $page, search_filter => $search_filter, size => $size, sort => $sort);
    print Dumper($result);
};
if ($@) {
