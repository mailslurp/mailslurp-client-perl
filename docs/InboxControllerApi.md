...
> create_inbox_ruleset(inbox_id => $inbox_id, create_inbox_ruleset_options => $create_inbox_ruleset_options)
...
eval { 
    $api_instance->create_inbox_ruleset(inbox_id => $inbox_id, create_inbox_ruleset_options => $create_inbox_ruleset_options);
};
if ($@) {
...
# **list_inbox_rulesets**
> list_inbox_rulesets(inbox_id => $inbox_id, page => $page, search_filter => $search_filter, size => $size, sort => $sort)
...
eval { 
    $api_instance->list_inbox_rulesets(inbox_id => $inbox_id, page => $page, search_filter => $search_filter, size => $size, sort => $sort);
};
if ($@) {
