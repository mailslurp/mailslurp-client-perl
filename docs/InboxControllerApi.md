...
[**get_or_create_inbox_plus_address**](InboxControllerApi#get_or_create_inbox_plus_address) | **POST** /inboxes/{inboxId}/plus-addresses/get-or-create | Get or create a plus address by full address
[**get_or_create_plus_address_by_full_address**](InboxControllerApi#get_or_create_plus_address_by_full_address) | **POST** /inboxes/get-or-create-plus-address | Get or create a plus address by full address without inbox ID
...
[**import_email_into_inbox**](InboxControllerApi#import_email_into_inbox) | **POST** /inboxes/{inboxId}/emails/import | Import email into inbox from base64 MIME
[**import_email_into_inbox_bytes**](InboxControllerApi#import_email_into_inbox_bytes) | **POST** /inboxes/{inboxId}/emails/import/raw | Import email into inbox from raw MIME bytes
[**import_email_into_inbox_multipart**](InboxControllerApi#import_email_into_inbox_multipart) | **POST** /inboxes/{inboxId}/emails/import/multipart | Import email into inbox from multipart EML upload
...
> RulesetDto create_inbox_ruleset(inbox_id => $inbox_id, create_ruleset_options => $create_ruleset_options)
...
eval { 
    my $result = $api_instance->create_inbox_ruleset(inbox_id => $inbox_id, create_ruleset_options => $create_ruleset_options);
    print Dumper($result);
};
if ($@) {
...
# **does_inbox_exist**
> InboxExistsDto does_inbox_exist(email_address => $email_address, allow_catch_all => $allow_catch_all, ip_address => $ip_address, sender => $sender)
...
my $allow_catch_all = null; # boolean | Allow catch all
my $ip_address = "ip_address_example"; # string | IP address
my $sender = "sender_example"; # string | Sender

eval { 
    my $result = $api_instance->does_inbox_exist(email_address => $email_address, allow_catch_all => $allow_catch_all, ip_address => $ip_address, sender => $sender);
    print Dumper($result);
};
if ($@) {
 ...
 **allow_catch_all** | **boolean**| Allow catch all | [optional] 
...
my $search = "search_example"; # string | Optionally filter by search words partial matching name and email address
 ...
 **search** | **string**| Optionally filter by search words partial matching name and email address | [optional] 
...
# **get_or_create_inbox_plus_address**
> PlusAddressDto get_or_create_inbox_plus_address(inbox_id => $inbox_id, full_address => $full_address)
...
my $inbox_id = null; # string | ID of the inbox you want to target
my $full_address = "full_address_example"; # string | Full recipient address including +suffix. Example: `inbox+alias@domain.com`

eval { 
    my $result = $api_instance->get_or_create_inbox_plus_address(inbox_id => $inbox_id, full_address => $full_address);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling InboxControllerApi->get_or_create_inbox_plus_address: $@\n";
}
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **inbox_id** | [**string**]()| ID of the inbox you want to target | 
 **full_address** | **string**| Full recipient address including +suffix. Example: &#x60;inbox+alias@domain.com&#x60; | 
...
# **get_or_create_plus_address_by_full_address**
> PlusAddressDto get_or_create_plus_address_by_full_address(full_address => $full_address)
...
eval { 
    my $result = $api_instance->get_or_create_plus_address_by_full_address(full_address => $full_address);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling InboxControllerApi->get_or_create_plus_address_by_full_address: $@\n";
}
```
...
# **import_email_into_inbox**
> Email import_email_into_inbox(inbox_id => $inbox_id, import_email_options => $import_email_options)
...
my $inbox_id = null; # string | 
my $import_email_options = MailSlurp::Object::ImportEmailOptions->new(); # ImportEmailOptions | 

eval { 
    my $result = $api_instance->import_email_into_inbox(inbox_id => $inbox_id, import_email_options => $import_email_options);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling InboxControllerApi->import_email_into_inbox: $@\n";
}
```
...
------------- | ------------- | ------------- | -------------
 **inbox_id** | [**string**]()|  | 
 **import_email_options** | [**ImportEmailOptions**](ImportEmailOptions)|  | 
...
# **import_email_into_inbox_bytes**
> Email import_email_into_inbox_bytes(inbox_id => $inbox_id, body => $body, external_id => $external_id, run_pipeline => $run_pipeline, override_message_id => $override_message_id)
...
my $inbox_id = null; # string | 
my $body = MailSlurp::Object::string->new(); # string | 
my $external_id = "external_id_example"; # string | 
my $run_pipeline = false; # boolean | 
my $override_message_id = true; # boolean | 

eval { 
    my $result = $api_instance->import_email_into_inbox_bytes(inbox_id => $inbox_id, body => $body, external_id => $external_id, run_pipeline => $run_pipeline, override_message_id => $override_message_id);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling InboxControllerApi->import_email_into_inbox_bytes: $@\n";
}
```
 ...
 **run_pipeline** | **boolean**|  | [optional] [default to false]
 **override_message_id** | **boolean**|  | [optional] [default to true]
...
# **import_email_into_inbox_multipart**
> Email import_email_into_inbox_multipart(inbox_id => $inbox_id, file => $file, external_id => $external_id, run_pipeline => $run_pipeline, override_message_id => $override_message_id)
...
eval { 
    my $result = $api_instance->import_email_into_inbox_multipart(inbox_id => $inbox_id, file => $file, external_id => $external_id, run_pipeline => $run_pipeline, override_message_id => $override_message_id);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling InboxControllerApi->import_email_into_inbox_multipart: $@\n";
}
```
...
# **list_inbox_rulesets**
> PageRulesetDto list_inbox_rulesets(inbox_id => $inbox_id, page => $page, size => $size, sort => $sort, search_filter => $search_filter, since => $since, before => $before)
