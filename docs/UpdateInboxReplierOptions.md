# MailSlurp::Object::UpdateInboxReplierOptions
...
**field** | **string** | Field to match against to trigger inbox replier for inbound email | [optional] 
**match** | **string** | String or wildcard style match for field specified when evaluating reply rules | [optional] 
