...
[**get_tenant_reputation_findings**](BounceControllerApi#get_tenant_reputation_findings) | **GET** /bounce/tenant-findings | Get SES tenant reputation findings
[**get_tenant_reputation_status_summary**](BounceControllerApi#get_tenant_reputation_status_summary) | **GET** /bounce/tenant-status | Get SES tenant status summary
...
# **get_tenant_reputation_findings**
> TenantReputationFindingsDto get_tenant_reputation_findings(account_region => $account_region)
...
my $account_region = "account_region_example"; # string | Optional account region filter

eval { 
    my $result = $api_instance->get_tenant_reputation_findings(account_region => $account_region);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling BounceControllerApi->get_tenant_reputation_findings: $@\n";
}
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **account_region** | **string**| Optional account region filter | [optional] 
...
# **get_tenant_reputation_status_summary**
> TenantReputationStatusSummaryDto get_tenant_reputation_status_summary(account_region => $account_region)
...
eval { 
    my $result = $api_instance->get_tenant_reputation_status_summary(account_region => $account_region);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling BounceControllerApi->get_tenant_reputation_status_summary: $@\n";
}
```
