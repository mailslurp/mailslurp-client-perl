...
> ARRAY[string] upload_multipart_form(content_id => $content_id, content_type => $content_type, filename => $filename, content_type_header => $content_type_header, x_filename => $x_filename, x_filename_raw => $x_filename_raw, x_filesize => $x_filesize, inline_object2 => $inline_object2)
...
my $inline_object2 = MailSlurp::Object::InlineObject2->new(); # InlineObject2 | 

eval { 
    my $result = $api_instance->upload_multipart_form(content_id => $content_id, content_type => $content_type, filename => $filename, content_type_header => $content_type_header, x_filename => $x_filename, x_filename_raw => $x_filename_raw, x_filesize => $x_filesize, inline_object2 => $inline_object2);
    print Dumper($result);
};
if ($@) {
 ...
 **inline_object2** | [**InlineObject2**](InlineObject2)|  | [optional] 
