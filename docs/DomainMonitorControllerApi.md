...
------------- | ------------- | -------------
[**compare_domain_monitor_runs**](DomainMonitorControllerApi#compare_domain_monitor_runs) | **GET** /domain-monitor/monitors/{monitorId}/runs/{runId}/compare/{otherRunId} | Compare two monitor runs
...
[**get_domain_monitor_auth_stack**](DomainMonitorControllerApi#get_domain_monitor_auth_stack) | **GET** /domain-monitor/monitors/{monitorId}/auth-stack | Get current auth stack for monitor domain
...
[**get_domain_monitor_run**](DomainMonitorControllerApi#get_domain_monitor_run) | **GET** /domain-monitor/monitors/{monitorId}/runs/{runId} | Get monitor run
...
[**get_domain_monitor_summary**](DomainMonitorControllerApi#get_domain_monitor_summary) | **GET** /domain-monitor/monitors/{monitorId}/summary | Get domain monitor summary
...
# **compare_domain_monitor_runs**
> DomainMonitorRunComparisonDto compare_domain_monitor_runs(monitor_id => $monitor_id, run_id => $run_id, other_run_id => $other_run_id)
...
my $other_run_id = null; # string | 

eval { 
    my $result = $api_instance->compare_domain_monitor_runs(monitor_id => $monitor_id, run_id => $run_id, other_run_id => $other_run_id);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling DomainMonitorControllerApi->compare_domain_monitor_runs: $@\n";
}
```
...
# **get_domain_monitor_auth_stack**
> CheckEmailAuthStackResults get_domain_monitor_auth_stack(monitor_id => $monitor_id, dkim_selector => $dkim_selector)
...
my $monitor_id = null; # string | 
my $dkim_selector = "dkim_selector_example"; # string | 

eval { 
    my $result = $api_instance->get_domain_monitor_auth_stack(monitor_id => $monitor_id, dkim_selector => $dkim_selector);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling DomainMonitorControllerApi->get_domain_monitor_auth_stack: $@\n";
}
```
...
# **get_domain_monitor_run**
> DomainMonitorRunDto get_domain_monitor_run(monitor_id => $monitor_id, run_id => $run_id)
...
eval { 
    my $result = $api_instance->get_domain_monitor_run(monitor_id => $monitor_id, run_id => $run_id);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling DomainMonitorControllerApi->get_domain_monitor_run: $@\n";
}
```
...
# **get_domain_monitor_summary**
> DomainMonitorSummaryDto get_domain_monitor_summary(monitor_id => $monitor_id, dkim_selector => $dkim_selector)
...
eval { 
    my $result = $api_instance->get_domain_monitor_summary(monitor_id => $monitor_id, dkim_selector => $dkim_selector);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling DomainMonitorControllerApi->get_domain_monitor_summary: $@\n";
}
```
