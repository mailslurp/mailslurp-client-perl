...
> PageMissedEmailProjection get_all_missed_emails(inbox_id => $inbox_id, page => $page, search_filter => $search_filter, size => $size, sort => $sort)
...
eval { 
    my $result = $api_instance->get_all_missed_emails(inbox_id => $inbox_id, page => $page, search_filter => $search_filter, size => $size, sort => $sort);
    print Dumper($result);
};
if ($@) {
...
> PageUnknownMissedEmailProjection get_all_unknown_missed_emails(inbox_id => $inbox_id, page => $page, search_filter => $search_filter, size => $size, sort => $sort)
...
eval { 
    my $result = $api_instance->get_all_unknown_missed_emails(inbox_id => $inbox_id, page => $page, search_filter => $search_filter, size => $size, sort => $sort);
    print Dumper($result);
};
if ($@) {
...
> MissedEmail wait_for_nth_missed_email(inbox_id => $inbox_id, index => $index, timeout => $timeout)
...
eval { 
    my $result = $api_instance->wait_for_nth_missed_email(inbox_id => $inbox_id, index => $index, timeout => $timeout);
    print Dumper($result);
};
if ($@) {
