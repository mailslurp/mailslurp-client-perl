...
[**create_webhook_for_ai_transformer**](WebhookControllerApi#create_webhook_for_ai_transformer) | **POST** /ai-transformers/{transformerId}/webhooks | Attach a WebHook URL to an AI transformer
...
[**get_test_webhook_payload_new_ai_transform_result**](WebhookControllerApi#get_test_webhook_payload_new_ai_transform_result) | **GET** /webhooks/test/new-ai-transform-result-payload | Get webhook test payload for new ai transform result event
...
# **create_webhook_for_ai_transformer**
> WebhookDto create_webhook_for_ai_transformer(transformer_id => $transformer_id, create_webhook_options => $create_webhook_options)
...
my $transformer_id = null; # string | 
my $create_webhook_options = MailSlurp::Object::CreateWebhookOptions->new(); # CreateWebhookOptions | 

eval { 
    my $result = $api_instance->create_webhook_for_ai_transformer(transformer_id => $transformer_id, create_webhook_options => $create_webhook_options);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling WebhookControllerApi->create_webhook_for_ai_transformer: $@\n";
}
```
...
my $ai_transformer_id = null; # string | AI Transformer ID
 ...
 **ai_transformer_id** | [**string**]()| AI Transformer ID | [optional] 
...
# **get_all_webhooks**
> PageWebhookProjection get_all_webhooks(page => $page, size => $size, sort => $sort, search_filter => $search_filter, since => $since, inbox_id => $inbox_id, ai_transformer_id => $ai_transformer_id, phone_id => $phone_id, before => $before, health => $health, event_type => $event_type, url => $url, event_type_source => $event_type_source, include_account_wide => $include_account_wide)
...
my $since = DateTime->from_epoch(epoch => str2time('null')); # DateTime | Filter by created at after the given timestamp
my $inbox_id = null; # string | Filter by inboxId
my $ai_transformer_id = null; # string | Filter by aiTransformerId
my $phone_id = null; # string | Filter by phoneId
my $before = DateTime->from_epoch(epoch => str2time('null')); # DateTime | Filter by created at before the given timestamp
my $health = "health_example"; # string | Filter by webhook health
my $event_type = "event_type_example"; # string | Optional event type
my $url = "url_example"; # string | Optional url endpoint filter
my $event_type_source = "event_type_source_example"; # string | Webhook source type category such as phone, inbox, aiTranformer
my $include_account_wide = null; # boolean | Include account scope webhooks when passing phoneId, inboxId, or aiTransformerId filters

eval { 
    my $result = $api_instance->get_all_webhooks(page => $page, size => $size, sort => $sort, search_filter => $search_filter, since => $since, inbox_id => $inbox_id, ai_transformer_id => $ai_transformer_id, phone_id => $phone_id, before => $before, health => $health, event_type => $event_type, url => $url, event_type_source => $event_type_source, include_account_wide => $include_account_wide);
    print Dumper($result);
};
if ($@) {
 ...
 **since** | **DateTime**| Filter by created at after the given timestamp | [optional] 
 **inbox_id** | [**string**]()| Filter by inboxId | [optional] 
 **ai_transformer_id** | [**string**]()| Filter by aiTransformerId | [optional] 
 **phone_id** | [**string**]()| Filter by phoneId | [optional] 
 **before** | **DateTime**| Filter by created at before the given timestamp | [optional] 
 **health** | **string**| Filter by webhook health | [optional] 
 **event_type** | **string**| Optional event type | [optional] 
 **url** | **string**| Optional url endpoint filter | [optional] 
 **event_type_source** | **string**| Webhook source type category such as phone, inbox, aiTranformer | [optional] 
 **include_account_wide** | **boolean**| Include account scope webhooks when passing phoneId, inboxId, or aiTransformerId filters | [optional] 
...
> PageWebhookProjection get_inbox_webhooks_paginated(inbox_id => $inbox_id, page => $page, size => $size, sort => $sort, search_filter => $search_filter, since => $since, before => $before, health => $health, event_type => $event_type, include_account_wide => $include_account_wide)
...
my $health = "health_example"; # string | Filter by webhook health
my $event_type = "event_type_example"; # string | Optional event type
my $include_account_wide = null; # boolean | Include account scope inbox webhooks

eval { 
    my $result = $api_instance->get_inbox_webhooks_paginated(inbox_id => $inbox_id, page => $page, size => $size, sort => $sort, search_filter => $search_filter, since => $since, before => $before, health => $health, event_type => $event_type, include_account_wide => $include_account_wide);
    print Dumper($result);
};
if ($@) {
 ...
 **health** | **string**| Filter by webhook health | [optional] 
 **event_type** | **string**| Optional event type | [optional] 
 **include_account_wide** | **boolean**| Include account scope inbox webhooks | [optional] 
...
> PageWebhookProjection get_phone_number_webhooks_paginated(phone_id => $phone_id, page => $page, size => $size, sort => $sort, since => $since, before => $before, event_type => $event_type, search_filter => $search_filter, health => $health, include_account_wide => $include_account_wide)
...
my $search_filter = "search_filter_example"; # string | Optional search filter
my $health = "health_example"; # string | Filter by webhook health
my $include_account_wide = null; # boolean | Include account scope phone webhooks

eval { 
    my $result = $api_instance->get_phone_number_webhooks_paginated(phone_id => $phone_id, page => $page, size => $size, sort => $sort, since => $since, before => $before, event_type => $event_type, search_filter => $search_filter, health => $health, include_account_wide => $include_account_wide);
    print Dumper($result);
};
if ($@) {
 ...
 **search_filter** | **string**| Optional search filter | [optional] 
 **health** | **string**| Filter by webhook health | [optional] 
 **include_account_wide** | **boolean**| Include account scope phone webhooks | [optional] 
...
# **get_test_webhook_payload_new_ai_transform_result**
> WebhookNewAITransformResultPayload get_test_webhook_payload_new_ai_transform_result()
...
eval { 
    my $result = $api_instance->get_test_webhook_payload_new_ai_transform_result();
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling WebhookControllerApi->get_test_webhook_payload_new_ai_transform_result: $@\n";
}
```
...
# **update_webhook**
> WebhookDto update_webhook(webhook_id => $webhook_id, create_webhook_options => $create_webhook_options, inbox_id => $inbox_id, ai_transformer_id => $ai_transformer_id, phone_number_id => $phone_number_id, override_auth => $override_auth)
...
my $create_webhook_options = MailSlurp::Object::CreateWebhookOptions->new(); # CreateWebhookOptions | 
my $inbox_id = null; # string | 
my $ai_transformer_id = null; # string | 
my $phone_number_id = null; # string | 
my $override_auth = null; # boolean | 

eval { 
    my $result = $api_instance->update_webhook(webhook_id => $webhook_id, create_webhook_options => $create_webhook_options, inbox_id => $inbox_id, ai_transformer_id => $ai_transformer_id, phone_number_id => $phone_number_id, override_auth => $override_auth);
    print Dumper($result);
};
if ($@) {
