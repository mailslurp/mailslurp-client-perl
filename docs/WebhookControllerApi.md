...
> PageWebhookResult get_all_webhook_results(page => $page, search_filter => $search_filter, size => $size, sort => $sort)
...
eval { 
    my $result = $api_instance->get_all_webhook_results(page => $page, search_filter => $search_filter, size => $size, sort => $sort);
    print Dumper($result);
};
if ($@) {
...
# **get_all_webhooks**
> PageWebhookProjection get_all_webhooks(page => $page, search_filter => $search_filter, size => $size, sort => $sort)
...
eval { 
    my $result = $api_instance->get_all_webhooks(page => $page, search_filter => $search_filter, size => $size, sort => $sort);
    print Dumper($result);
};
if ($@) {
...
> PageWebhookProjection get_inbox_webhooks_paginated(inbox_id => $inbox_id, page => $page, search_filter => $search_filter, size => $size, sort => $sort)
...
eval { 
    my $result = $api_instance->get_inbox_webhooks_paginated(inbox_id => $inbox_id, page => $page, search_filter => $search_filter, size => $size, sort => $sort);
    print Dumper($result);
};
if ($@) {
...
# **get_webhook_result**
> WebhookResultEntity get_webhook_result(webhook_result_id => $webhook_result_id)
...
# **get_webhook_results**
> PageWebhookResult get_webhook_results(webhook_id => $webhook_id, page => $page, search_filter => $search_filter, size => $size, sort => $sort)
...
eval { 
    my $result = $api_instance->get_webhook_results(webhook_id => $webhook_id, page => $page, search_filter => $search_filter, size => $size, sort => $sort);
    print Dumper($result);
};
if ($@) {
