...
> PageWebhookResult get_all_webhook_results(page => $page, size => $size, sort => $sort)
...
eval { 
    my $result = $api_instance->get_all_webhook_results(page => $page, size => $size, sort => $sort);
    print Dumper($result);
};
if ($@) {
...
# **get_webhook_results**
> PageWebhookResult get_webhook_results(webhook_id => $webhook_id, page => $page, size => $size, sort => $sort)
...
eval { 
    my $result = $api_instance->get_webhook_results(webhook_id => $webhook_id, page => $page, size => $size, sort => $sort);
    print Dumper($result);
};
if ($@) {
