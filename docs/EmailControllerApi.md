...
# **search_emails**
> PageEmailProjection search_emails(search_emails_options => $search_emails_options)
...
eval { 
    my $result = $api_instance->search_emails(search_emails_options => $search_emails_options);
    print Dumper($result);
};
if ($@) {
