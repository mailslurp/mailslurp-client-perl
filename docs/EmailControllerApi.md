...
> send_email_source_optional(send_email_options => $send_email_options, inbox_id => $inbox_id, use_domain_pool => $use_domain_pool)
...
eval { 
    $api_instance->send_email_source_optional(send_email_options => $send_email_options, inbox_id => $inbox_id, use_domain_pool => $use_domain_pool);
};
if ($@) {
