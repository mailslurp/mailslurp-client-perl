...
# **download_attachment**
> ARRAY[string] download_attachment(email_id => $email_id, attachment_id => $attachment_id, api_key => $api_key)
...
# **download_body_bytes**
> ARRAY[string] download_body_bytes(email_id => $email_id)
...
> send_email_source_optional(inbox_id => $inbox_id, send_email_options => $send_email_options, use_domain_pool => $use_domain_pool)
...
eval { 
    $api_instance->send_email_source_optional(inbox_id => $inbox_id, send_email_options => $send_email_options, use_domain_pool => $use_domain_pool);
};
if ($@) {
