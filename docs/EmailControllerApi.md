...
eval { 
    my $result = $api_instance->get_emails_paginated(inbox_id => $inbox_id, page => $page, search_filter => $search_filter, size => $size, sort => $sort, unread_only => $unread_only);
    print Dumper($result);
};
if ($@) {
...
eval { 
    my $result = $api_instance->get_organization_emails_paginated(inbox_id => $inbox_id, page => $page, search_filter => $search_filter, size => $size, sort => $sort, unread_only => $unread_only);
    print Dumper($result);
};
if ($@) {
