...
> InboxForwarderDto create_new_inbox_forwarder(inbox_id => $inbox_id, create_inbox_forwarder_options => $create_inbox_forwarder_options)
...
eval { 
    my $result = $api_instance->create_new_inbox_forwarder(inbox_id => $inbox_id, create_inbox_forwarder_options => $create_inbox_forwarder_options);
    print Dumper($result);
};
if ($@) {
...
> PageInboxForwarderEvents get_all_inbox_forwarder_events(page => $page, size => $size, inbox_id => $inbox_id, sort => $sort)
...
eval { 
    my $result = $api_instance->get_all_inbox_forwarder_events(page => $page, size => $size, inbox_id => $inbox_id, sort => $sort);
    print Dumper($result);
};
if ($@) {
